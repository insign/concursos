---
schemaVersion: 1
title: "Infrações, sanções, controle, PNCP e regras finais"
description: "Nulidade, meios alternativos de resolução de controvérsias, infrações, sanções, recursos, controle, PNCP e disposições finais da Lei nº 14.133/2021."
order: 130
storageId: "sancoes-controle-pncp"
---
...
| como prevenir, fiscalizar e dar transparência? | linhas de defesa, tribunal de contas e <abbr title="Portal Nacional de Contratações Públicas">PNCP</abbr> |
...
### 7.1 <abbr title="Cadastro Nacional de Empresas Inidôneas e Suspensas">CEIS</abbr>, <abbr title="Cadastro Nacional de Empresas Punidas">CNEP</abbr> e reabilitação

Órgãos e entidades dos Poderes Executivo, Legislativo e Judiciário de todos os entes federativos devem informar e manter atualizados, em até **15 dias úteis da aplicação da sanção**, os dados necessários à publicidade no <abbr title="Cadastro Nacional de Empresas Inidôneas e Suspensas">CEIS</abbr> e no <abbr title="Cadastro Nacional de Empresas Punidas">CNEP</abbr>.
...
Na fiscalização, os órgãos consideram <abbr title="conveniência de atuar diante do caso e do momento">oportunidade</abbr>, <abbr title="importância do fato conforme valor, dimensão ou impacto">materialidade</abbr>, <abbr title="importância do tema para os objetivos e interesses protegidos">relevância</abbr> e <abbr title="probabilidade e impacto de resultado indesejado">risco</abbr>, além das razões dos gestores e dos resultados da contratação. Qualquer licitante, contratado ou pessoa física ou jurídica pode representar ao controle interno ou ao tribunal de contas competente.
...
## 10. <abbr title="Portal Nacional de Contratações Públicas">PNCP</abbr>: publicidade obrigatória, contratação pelo portal facultativa

O <abbr title="Portal Nacional de Contratações Públicas">PNCP</abbr> possui duas funções que não devem ser confundidas:
...
**Eficácia** é a aptidão do contrato para produzir os efeitos jurídicos previstos. Como regra, a divulgação no <abbr title="Portal Nacional de Contratações Públicas">PNCP</abbr> é condição indispensável à eficácia do contrato e de seus aditamentos:
...
Os entes podem manter sítios eletrônicos complementares e usar sistema fornecido por pessoa jurídica de direito público ou privado, desde que integrado ao <abbr title="Portal Nacional de Contratações Públicas">PNCP</abbr>, conforme a regulamentação aplicável.
...
Enquanto não adotarem o <abbr title="Portal Nacional de Contratações Públicas">PNCP</abbr>, devem publicar em diário oficial as informações exigidas em sítio eletrônico oficial, admitido extrato, e disponibilizar os documentos fisicamente, cobrando apenas eventual custo de reprodução.
...
O artigo 177 alterou o <abbr title="Código de Processo Civil">CPC</abbr> para dar prioridade de tramitação a processos que discutam a aplicação das normas gerais de licitação e contratação referidas no artigo 22, XXVII, da Constituição.
...
O artigo 182 manda o Poder Executivo federal atualizar, em cada **1º de janeiro**, os valores da Lei pelo <abbr title="Índice Nacional de Preços ao Consumidor Amplo Especial">IPCA-E</abbr> ou índice substituto e divulgá-los no <abbr title="Portal Nacional de Contratações Públicas">PNCP</abbr>.
...
O artigo 193 revogou os antigos crimes dos artigos 89 a 108 da Lei nº 8.666/1993 já na publicação da nova Lei e, em **30 de dezembro de 2023**, revogou a Lei nº 8.666/1993, a Lei nº 10.520/2002 e os artigos 1º a 47-A do <abbr title="Regime Diferenciado de Contratações Públicas">RDC</abbr>, conforme a Lei Complementar nº 198/2023.
