...
$$
\text{rede vitorinista} + \text{eleição contestada} + \text{impasse eleitoral}
\rightarrow \text{duas fases da greve}
$$
...
1. eleição em 3 out. 1950;
2. anulações e recursos;
3. morte de Saturnino em jan. 1951;
