# Prisão em flagrante — revisão rápida

## 301: quem prende

- qualquer pessoa **pode** prender;
- autoridade policial e seus agentes **devem** prender quem esteja em situação legal de flagrante.

## 302: mapa das quatro hipóteses

| Inciso | Gatilho | Nome usual |
| --- | --- | --- |
| I | está cometendo | próprio |
| II | acaba de cometer | próprio |
...
Flagrante enquanto **não cessar a permanência**.

## Esperado x preparado

- esperado: polícia aguarda, sem provocar → pode ser válido;
- preparado: polícia provoca e torna impossível a consumação → Súmula 145/<abbr title="Supremo Tribunal Federal">STF</abbr>;
- forjado: situação incriminadora é artificialmente fabricada → inválido.
...
Sem testemunha ocular do crime: auto continua possível; com o condutor, assinam **2 testemunhas da apresentação**.

Acusado recusa/não sabe/não pode assinar: **2 testemunhas que ouviram a leitura na presença dele**.

O auto registra também existência de filhos, idades, eventual deficiência e responsável pelos cuidados.
...
2. requisitos cautelares próprios → pode **converter em preventiva**;
3. prisão legal sem manutenção cautelar → **liberdade provisória**, com ou sem fiança.

Flagrante ≠ preventiva automática.
...
- preferencialmente na audiência;
- ou em até **10 dias**;
- agente público treinado;
- cadeia de custódia.
