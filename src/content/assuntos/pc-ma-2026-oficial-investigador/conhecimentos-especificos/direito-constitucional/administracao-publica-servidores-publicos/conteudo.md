---
schemaVersion: 1
title: "Administração pública e servidores públicos na Constituição"
description: "Disposições constitucionais sobre Administração pública e servidores públicos, com foco nos arts. 37 a 41: princípios, ingresso, remuneração, acumulação, mandato eletivo, regime de pessoal, previdência e estabilidade."
order: 116
storageId: pc-u116
---
...
Para a Polícia Civil do Maranhão, esta unidade fornece o **patamar constitucional**. A Lei nº 8.112/1990, o regime geral dos servidores maranhenses e os estatutos policiais possuem unidades próprias; seus prazos e vantagens não devem ser transportados para cá como se fossem texto da Constituição.

O art. 37 começa pelo comando mais amplo. A administração pública **direta e indireta de qualquer dos Poderes** da União, dos Estados, do Distrito Federal e dos Municípios deve obedecer a legalidade, impessoalidade, moralidade, publicidade e eficiência — o mnemônico <abbr title="Legalidade, Impessoalidade, Moralidade, Publicidade e Eficiência">LIMPE</abbr>.
...
> **Corte legislativo:** esta unidade considera o texto vigente em **13 de julho de 2026**, data do Edital nº 1 da Polícia Civil do Maranhão para Oficial Investigador. Nesse corte já vigoravam as Emendas Constitucionais nº 135/2024 e nº 138/2025 e o julgamento definitivo da <abbr title="Ação Direta de Inconstitucionalidade">ADI</abbr> 2.135 pelo <abbr title="Supremo Tribunal Federal">STF</abbr>. A Emenda Constitucional nº 139/2026, a última anterior ao edital, alterou os arts. 31 e 75 e não modificou os arts. 37 a 41.
...
O teto nacional toma como referência o subsídio mensal dos Ministros do <abbr title="Supremo Tribunal Federal">STF</abbr>. Nos entes subnacionais, a Constituição estabelece referências próprias:
...
| Estado/Distrito Federal — Judiciário | subsídio dos **Desembargadores do Tribunal de Justiça**, limitado a **90,25%** do subsídio dos Ministros do <abbr title="Supremo Tribunal Federal">STF</abbr> |
...
> **Jurisprudência de 2026:** ao concluir, em 30 de junho de 2026, recursos em conjunto que incluíram os Temas 966 e 976 e as <abbr title="Ações Diretas de Inconstitucionalidade">ADIs</abbr> 6.601, 6.604 e 6.606, o <abbr title="Supremo Tribunal Federal">STF</abbr> manteve regras de transição para limitar e padronizar determinadas parcelas indenizatórias no Judiciário e no Ministério Público. Esse regime jurisprudencial específico **não é autorização geral** para excluir verbas do teto em qualquer carreira do Executivo; para esta unidade, a regra-base continua sendo o art. 37, § 11.
...
No corte de 13/7/2026, as hipóteses são:
...
## 9. Art. 39: política de pessoal depois da <abbr title="Ação Direta de Inconstitucionalidade">ADI</abbr> 2.135
...
No julgamento definitivo da <abbr title="Ação Direta de Inconstitucionalidade">ADI</abbr> 2.135, em 6 de novembro de 2024, o <abbr title="Supremo Tribunal Federal">STF</abbr> reconheceu a constitucionalidade dessa retirada. A decisão foi projetada para **contratações futuras**, sem mudança automática do regime dos servidores atuais. Portanto, no corte de 2026, é incorreto afirmar que a Constituição ainda impõe regime jurídico único a todos os entes.
...
O art. 40 disciplina o <abbr title="Regime Próprio de Previdência Social">RPPS</abbr> dos **servidores titulares de cargos efetivos**. O regime é contributivo e solidário e deve preservar equilíbrio financeiro e <abbr title="Equilíbrio entre contribuições e obrigações futuras do regime">atuarial</abbr>.

Por outro lado, o art. 40, § 13, aplica o <abbr title="Regime Geral de Previdência Social">RGPS</abbr> ao agente que ocupe exclusivamente:
...
## 11. Aposentadoria no <abbr title="Regime Próprio de Previdência Social">RPPS</abbr>: três portas principais

### 11.1 Incapacidade permanente

O servidor abrangido por <abbr title="Regime Próprio de Previdência Social">RPPS</abbr> será aposentado por incapacidade permanente para o trabalho no cargo quando for **insuscetível de readaptação**. A permanência das condições deve ser verificada por avaliações periódicas, na forma da lei do respectivo ente.
...
## 12. Regras diferenciadas e travas do <abbr title="Regime Próprio de Previdência Social">RPPS</abbr>

A Constituição admite disciplina diferenciada, nos limites previstos, para servidores com deficiência, determinadas carreiras de segurança e atividades com efetiva exposição a agentes nocivos. Para carreiras policiais, a autorização constitucional a critérios diferenciados de aposentadoria não significa que requisitos federais transitórios possam ser copiados automaticamente para a Polícia Civil estadual. Para professores que cumpram os requisitos constitucionais de funções de magistério na educação infantil e nos ensinos fundamental e médio, a idade mínima é reduzida em **cinco anos**.

Outras travas importantes:

- em regra, é vedada mais de uma aposentadoria à conta de <abbr title="Regime Próprio de Previdência Social">RPPS</abbr>, ressalvadas as decorrentes de cargos acumuláveis;
...
- cada ente possui **um único <abbr title="Regime Próprio de Previdência Social">RPPS</abbr> e uma única entidade ou órgão gestor** para todos os Poderes, órgãos e entidades autárquicas e fundacionais;
- o § 22 veda a instituição de **novos <abbr title="Regimes Próprios de Previdência Social">RPPS</abbr>** e remete a lei complementar federal às normas gerais dos regimes já existentes;
...
2. mediante processo administrativo em que seja assegurada ampla defesa;
...
1. **ingresso** → concurso, comissão, confiança, temporário;
2. **exercício** → princípios, sindicalização, publicidade, responsabilidade;
3. **remuneração e vínculos** → teto, lei específica, acumulação;
4. **mandato eletivo** → afastamento e compatibilidade;
5. **política de pessoal** → art. 39 e subsídio;
6. **previdência** → cargo efetivo leva ao <abbr title="Regime Próprio de Previdência Social">RPPS</abbr>; vínculos do § 13 levam ao <abbr title="Regime Geral de Previdência Social">RGPS</abbr>;
7. **estabilidade e desligamento** → três anos, avaliação, art. 41 e art. 169.
...
## 17. Fronteiras com Direito Administrativo e com os estatutos policiais

Esta unidade termina no nível constitucional:

- a **Lei nº 8.112/1990** já foi estudada em U100;
- o regime geral dos servidores públicos civis do Maranhão está em U109;
- o Estatuto da Polícia Civil do Maranhão está em U108;
- organização administrativa, atos, poderes e controle possuem unidades próprias.

Use esses capítulos para concretizar a Constituição, mas não transforme regras legais específicas — posse, licenças, deveres, penalidades ou estágio probatório de um estatuto — em comandos do art. 37 a 41.
