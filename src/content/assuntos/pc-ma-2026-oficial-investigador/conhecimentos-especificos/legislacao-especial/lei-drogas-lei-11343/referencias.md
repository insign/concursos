...
O edital admite jurisprudência de tribunais superiores publicada até **30 dias antes das provas**. A prova estava inicialmente prevista para 6 dez. 2026. A consulta desta unidade foi realizada em **20 set. 2026**, antes do fechamento dessa janela; por isso, esta referência registra apenas precedentes e enunciados já publicados e exige revalidação final em PC-F03, sem converter 13 jul. 2026 em corte jurisprudencial.

## Questões anteriores

Nenhuma questão anterior foi incorporada ao conjunto U123. Foram priorizadas questões autorais porque o recorte exigido é a **lei integral no estado normativo de 13 jul. 2026**, incluindo alteração de março de 2026 e jurisprudência vinculante/consolidada que precisa ser apresentada sem atribuição fictícia a banca, ano ou prova. Não foi criada quota artificial de questões anteriores.
