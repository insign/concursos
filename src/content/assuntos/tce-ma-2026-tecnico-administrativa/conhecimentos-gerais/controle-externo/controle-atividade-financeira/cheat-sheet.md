...
| Dimensão | Foco |
| --- | --- |
| **C**ontábil | registros e demonstrações |
| **F**inanceira | entradas, saídas, caixa, crédito e dívida |
| **O**rçamentária | planejamento, autorização e execução |
| **O**peracional | processos, desempenho e resultados |
| **P**atrimonial | bens, direitos e obrigações |
