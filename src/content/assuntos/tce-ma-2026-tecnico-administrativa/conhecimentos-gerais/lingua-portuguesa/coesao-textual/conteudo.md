---
schemaVersion: 1
title: Coesão por referenciação, substituição, repetição, conectores e sequenciação
description: Mecanismos de referenciação, substituição, repetição, conectores e progressão que articulam as partes de um texto.
order: 4
storageId: tec-coesao-textual
---
