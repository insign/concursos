...
order: 1
storageId: tec-leitura-tipos-generos
---
...
A banca costuma transformar uma leitura correta em alternativa errada por meio de uma única palavra. Antes de discutir conceitos, adote este roteiro:
...
6. **Julgue a alternativa inteira.** Uma única oração, condição ou consequência sem apoio torna toda a alternativa incorreta.
...
Uma alternativa pode começar fiel ao texto e terminar com um acréscimo indevido. **Metade correta não salva a alternativa.**
...
Em alternativa única, a resposta correta costuma ser a mais precisamente autorizada, não a mais interessante ou plausível fora do texto. **“Poder ser verdade” não basta.**
...
### Estudo 1 — tese, concessão, vozes e alternativa parcialmente correta
...
**Afirmação 1:** O texto rejeita a digitalização dos serviços públicos.  
**Não procede.** O primeiro período reconhece ganhos; a crítica recai sobre a suficiência da mera digitalização.

**Afirmação 2:** A opinião dos especialistas é incorporada como ressalva a uma avaliação inicialmente favorável.  
**Procede.** “Porém” introduz limite ao ganho reconhecido.

**Afirmação 3:** O autor defende que todo canal digital é inutilizável sem atendimento presencial.  
**Não procede.** O texto não universaliza nem declara inutilidade; sustenta a necessidade de condições complementares.

**Afirmação 4:** A tese é que modernização efetiva exige considerar as condições reais dos usuários.  
**Procede.** A conclusão reformula explicitamente essa posição.

**Afirmação 5:** O relatório resolveu as barreiras ao anunciar atendimento assistido.  
**Não procede.** O texto afirma que a medida é adequada, **mas não encerra o problema**. A afirmação começa fiel e termina com consequência contraditória.
...
**Afirmação 1:** A Unidade A cresceu 5 pontos percentuais.  
**Procede.** A diferença é 47% − 42% = 5 pontos percentuais.

**Afirmação 2:** A taxa da Unidade A aumentou apenas 5%.  
**Não procede.** Cinco pontos percentuais correspondem a crescimento relativo aproximado de 11,9% sobre 42%.

**Afirmação 3:** O gráfico pode produzir impressão visual ampliada porque o eixo não começa em zero.  
**Procede.** A faixa estreita aumenta a distância visual entre valores próximos.

**Afirmação 4:** A mudança no sistema de triagem foi a causa comprovada do aumento.  
**Não procede.** A nota registra coexistência temporal; não isola causalidade.

## 5. Método de conferência final

Antes de marcar, percorra oito perguntas:

1. A alternativa preserva o **quantificador**?
...
Se uma dessas dimensões foi alterada sem base textual, a alternativa está incorreta.
