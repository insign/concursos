...
- **M**odificar unilateralmente
- **E**xtinguir unilateralmente nos casos legais
- **F**iscalizar
- aplicar **S**anções
- **O**cupar provisoriamente bens/pessoal/serviços nas hipóteses legais
...
→ não muda sem concordância do contratado.

Alteração unilateral com impacto econômico:
→ recompor equilíbrio.
...
Associação pública:
→ integra administração indireta de **todos** os consorciados.

Consórcio privado:
→ regras públicas para licitações, contratos, contas e pessoal.
...
→ precisa homologação da assembleia geral.
...
Representante legal:
→ obrigatoriamente **Chefe do Poder Executivo** de ente consorciado.
...
Decreto 6.017, art. 29:
→ ainda traz redação antiga para alteração.
...
Falta de dotação para rateio:
→ pode gerar suspensão e depois exclusão, conforme a lei.
...
Lei 11.107:
→ aplica-se aos convênios de cooperação **no que couber**.
