...
|---|---|
| só servidor de **cargo efetivo** | preenchimento conforme lei |
| função | cargo |
...
Não alcança subsídios de Deputados Estaduais/Distritais e Vereadores.
...
Exceções só com **compatibilidade de horários** + teto:
...
| 6º | responsabilidade da PJ + regresso dolo/culpa |
...
ADI 2.135 → STF validou retirada (6/11/2024)
...
| voluntária subnacional | disciplina constitucional/local do ente |
...
PROFESSOR → redução constitucional de idade
```
...
```text
MEDIDAS ANTERIORES INSUFICIENTES
