---
schemaVersion: 1
title: "Lei nº 14.133/2021: extinção, recebimento e pagamento"
description: "Extinção dos contratos administrativos, recebimento do objeto, ordem cronológica, pagamento, remuneração variável e antecipação na Lei nº 14.133/2021."
order: 108
storageId: tec-extincao-pagamento
---
...
```mermaid
flowchart LR
    E[Execução e fiscalização] --> M[Medição e verificação]
    M --> R[Recebimento]
    R --> L[Liquidação]
    L --> O[Ordem cronológica]
    O --> P[Pagamento]
    E --> C{Causa de extinção?}
    C -- não --> M
    C -- sim --> D[Processo, defesa e motivação]
    D --> F[Forma adequada de extinção]
