---
schemaVersion: 1
title: "Lei nº 14.133/2021: infrações, sanções, controle, PNCP e regras finais"
...
order: 109
storageId: tec-sancoes-controle-pncp
---
...
```mermaid
flowchart TD
    I[Infração do art. 155] --> D[Instrução, defesa e dosimetria]
    D --> P{Enquadramento e gravidade}
    P -->|Inciso I, sem maior gravidade| A[Advertência]
    P -->|Qualquer inciso| M[Multa]
    P -->|Incisos II a VII| E[Impedimento: ente sancionador, até 3 anos]
    P -->|Incisos VIII a XII ou caso grave de II a VII| N[Inidoneidade: todos os entes, 3 a 6 anos]
    A --> R[Reparação integral permanece]
    M --> R
    E --> R
    N --> R
```
