...
description: "Noções de organização administrativa para o Cargo 16: centralização e descentralização, concentração e desconcentração, administração direta e indireta e regime básico de autarquias, fundações públicas, empresas públicas e sociedades de economia mista."
order: 142
storageId: tec-nocoes-org-adm-142
---
