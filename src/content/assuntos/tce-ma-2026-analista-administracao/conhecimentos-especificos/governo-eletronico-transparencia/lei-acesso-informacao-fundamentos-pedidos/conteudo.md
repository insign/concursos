...
A Lei nº 12.527/2011, Lei de Acesso à Informação (LAI), regulamenta o direito fundamental de acesso a informações públicas. Este assunto cobre princípios, diretrizes, abrangência, conceitos, conteúdo do direito, pedido, tramitação e prazos.
...
| art. 37, § 3º, II | lei disciplinará o acesso dos usuários a registros administrativos e informações sobre atos de governo |
| art. 216, § 2º | administração deve gerir documentação governamental e franquear sua consulta |

O acesso é direito fundamental, e não favor administrativo. Não depende de o requerente provar interesse especial ou explicar o uso pretendido.

## 3. Princípios e diretrizes

O art. 3º determina observância dos princípios básicos da administração pública e estabelece:
...
Logo, Cortes de Contas estão expressamente incluídas. A LAI é nacional; sua regulamentação operacional pode variar conforme ente e órgão.

### 4.2 Entidades privadas sem fins lucrativos

Entidades privadas sem fins lucrativos que recebam recursos públicos para ações de interesse público submetem-se à LAI no que couber. A publicidade refere-se à parcela dos recursos públicos recebidos e à sua destinação, sem tornar automaticamente pública toda atividade privada.
...
| --- | --- |
| informação | dados, processados ou não, utilizáveis para produção e transmissão de conhecimento |
...
| tratamento da informação | ações relativas à produção, recepção, classificação, uso, acesso, reprodução, transporte, transmissão, distribuição, arquivamento, armazenamento, eliminação, avaliação, destinação ou controle |
| disponibilidade | informação conhecida e utilizada por pessoas, equipamentos ou sistemas autorizados |
| autenticidade | produzida, expedida, recebida ou modificada por determinado indivíduo, equipamento ou sistema |
...
Pegadinhas: informação é conteúdo; documento é unidade de registro. Primariedade não significa atualidade. Integridade não identifica autoria; autenticidade relaciona a informação ao produtor, expedidor, recebedor ou modificador determinado.

## 6. Conteúdo do direito de acesso

O art. 7º contém enumeração exemplificativa: o direito compreende, **entre outros**:

- orientação sobre procedimento e local de acesso;
- informação em registros ou documentos produzidos ou acumulados, recolhidos ou não a arquivos públicos;
- informação produzida ou custodiada por pessoa física ou entidade privada em razão de vínculo com órgão público, mesmo após cessado o vínculo;
...
## 7. SIC e pedido de acesso

O Serviço de Informações ao Cidadão (SIC) deve:

- atender e orientar o público;
- informar sobre tramitação de documentos;
- protocolizar documentos e requerimentos de acesso.

Qualquer interessado pode apresentar pedido por meio legítimo. A orientação federal admite pessoa física ou jurídica. Pela lei, o pedido deve conter:

1. identificação do requerente, sem exigências que inviabilizem a solicitação;
2. especificação da informação requerida.

É vedada exigência relativa aos motivos determinantes da solicitação. Identificação não se confunde com motivação: a primeira é requisito; a segunda não pode ser exigida. Os órgãos devem viabilizar alternativa de pedido por seus sítios oficiais.

No Executivo federal, o Decreto nº 7.724/2012 detalha nome, documento válido, especificação clara e precisa e endereço para resposta, e afasta pedidos genéricos, desproporcionais, desarrazoados ou que exijam trabalho de análise, interpretação, consolidação ou tratamento fora da competência. Esses detalhes não devem ser transplantados automaticamente ao TCE-MA.

## 8. Tramitação e resposta

### 8.1 Acesso imediato e prazo ordinário

Se a informação estiver disponível, o órgão deve autorizar ou conceder acesso imediato. Se isso não for possível, em até **20 dias** deve:

- comunicar data, local e modo de consulta, reprodução ou obtenção de certidão;
- indicar as razões de fato ou de direito da recusa total ou parcial; ou
- comunicar que não possui a informação, indicar o detentor se souber ou remeter o pedido ao órgão competente, cientificando o interessado.
...
- Se a manipulação puder prejudicar a integridade do documento, oferece-se cópia certificada como fiel.
- Se não houver cópia, o interessado pode reproduzir às próprias expensas, sob supervisão e sem risco ao original.

Negativa deve ser motivada e acompanhada das informações recursais exigidas pela lei; o rito dos recursos será estudado no Assunto 141.

## 9. Gratuidade e custos

O serviço de busca e fornecimento é gratuito. Pode haver cobrança exclusivamente do valor necessário ao ressarcimento de serviços e materiais usados na reprodução de documentos.

É isento quem declarar, nos termos da Lei nº 7.115/1983, que o pagamento prejudicaria o próprio sustento ou o da família. Busca e análise não podem ser convertidas em taxa; a exceção legal é o custo de reprodução.

O prazo federal de reprodução após comprovação do pagamento é detalhe do Decreto nº 7.724/2012, não prazo nacional da LAI.

## 10. Quadro de prova

| Situação | Regra nacional da LAI |
| --- | --- |
...
| reprodução | ressarcimento estrito dos materiais e serviços |
| requerente sem recursos | isenção mediante declaração legal |
