...
- Organização oferece incentivos, condições, recursos e reconhecimento.
- Equilíbrio não é igualdade aritmética; envolve valor e justiça percebidos.
- Contrato psicológico = crenças subjetivas sobre promessas e obrigações.
- Não equivale a lei, estatuto, regulamento ou direito adquirido.
- Quebra = percepção cognitiva de descumprimento.
- Violação = reação afetiva intensa à quebra.
...
| Conceito | Núcleo |
| --- | --- |
| identificação | organização integra o autoconceito |
| afetivo | permanece porque quer |
| continuidade | permanece por custos ou necessidade percebidos |
| normativo | permanece por obrigação percebida |
| suporte percebido | organização valoriza contribuições e cuida do bem-estar |

- Comprometimento não é satisfação, motivação, desempenho ou obediência cega.

## Justiça

| Dimensão | Foco |
| --- | --- |
| distributiva | resultados, recursos e encargos |
| procedimental | critérios e processo decisório |
