---
schemaVersion: 1
title: "Gestão de pessoas: fundamentos, evolução e teorias administrativas"
description: "Conceitos, importância, visão sistêmica, evolução da área e impactos das principais escolas da administração na gestão de pessoas."
order: 142
storageId: "gp-fundamentos-teorias"
---
...
As etapas são tipos didáticos que podem coexistir:

| Estágio | Ênfase | Atividades típicas |
| --- | --- | --- |
| administração de pessoal/DP | conformidade e operação | registros, frequência, folha, benefícios e obrigações |
| administração de recursos humanos | processos especializados | recrutamento, seleção, treinamento, cargos, avaliação e relações de trabalho |
| gestão estratégica de pessoas | capacidades e resultados | alinhamento de pessoas, competências, cultura e estrutura à estratégia |

Gestão estratégica não elimina registros, legalidade ou rotinas. Ela integra essas atividades a prioridades institucionais. Pessoas não são apenas custos ou insumos: são portadoras de conhecimentos, habilidades, experiências, valores e capacidade de cooperação.

No setor público, o objetivo é produzir valor público sob legalidade, impessoalidade, profissionalismo, mérito, continuidade e interesse coletivo, não maximizar lucro.

## 3. Objetivos e importância

A gestão de pessoas busca:

- planejar quantitativos e competências necessários;
- atrair, selecionar, alocar e integrar pessoas;
- organizar trabalho, responsabilidades e condições de atuação;
- desenvolver capacidades e aprendizagem;
- reconhecer contribuições e administrar relações de trabalho;
- promover saúde, segurança, inclusão e qualidade de vida;
- produzir informações confiáveis e assegurar conformidade;
- sustentar resultados, inovação e continuidade institucional.

Resultados organizacionais e necessidades humanas não são necessariamente opostos. Uma gestão madura busca compatibilizá-los, reconhecendo conflitos reais e limites jurídicos, orçamentários e éticos.
...
## 4. Gestão de pessoas como sistema

Gestão de pessoas é subsistema aberto e interdependente:

| Sistema relacionado | Relação com GP |
| --- | --- |
| estratégia e governança | missão, prioridades, competências críticas, riscos e indicadores |
| estrutura e processos | cargos, divisão do trabalho, fluxos, coordenação e quantitativos |
| tecnologia e informação | novas competências, redesenho do trabalho e dados decisórios |
| orçamento e finanças | limites e escolhas sobre provimento, remuneração e desenvolvimento |
| cultura e comunicação | valores, cooperação, aprendizagem e circulação de conhecimento |
| ambiente externo | legislação, mercado, tecnologia, demandas sociais e políticas públicas |
...
- análise, padronização e especialização do trabalho;
- seleção e treinamento orientados à tarefa;
- separação entre planejamento gerencial e execução;
- incentivos vinculados à produtividade.
...
- hierarquia;
- documentação;
- seleção por qualificação técnica;
...
- **Herbert Simon:** racionalidade limitada e decisões satisfatórias, diante de limites de informação, tempo e cognição.
- **Chester Barnard:** organização como sistema cooperativo, comunicação e autoridade dependente de aceitação.
- **Maslow:** hierarquia de necessidades como modelo motivacional.
- **Herzberg:** fatores higiênicos evitam insatisfação; fatores motivacionais ligam-se ao conteúdo do trabalho.
- **McGregor:** Teorias X e Y são pressupostos gerenciais contrastantes, não tipos naturais fixos de trabalhador.
...
- totalidade: o todo não se reduz à soma isolada das partes;
- fronteiras e intercâmbio ambiental;
- feedback e adaptação;
- equifinalidade: diferentes caminhos podem alcançar resultados semelhantes;
- entropia e necessidade de renovação.
...
| --- | --- | --- |
| científica | tarefa | método e eficiência |
| clássica | estrutura geral | autoridade e coordenação |
| neoclássica | objetivos e resultados | APO e pragmatismo |
| burocrática | racionalidade legal | mérito e impessoalidade |
| relações humanas | grupos | organização informal |
| comportamental | decisão e comportamento | racionalidade e necessidades |
| estruturalista | formal, informal e conflitos | papéis e tensões |
