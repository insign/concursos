---
schemaVersion: 1
title: Controle e avaliação no processo organizacional
description: Função administrativa de controle, monitoramento, avaliação, indicadores, desvios e aplicação na Administração Pública.
order: 106
storageId: controle-avaliacao
---
