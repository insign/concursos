...
3. fiscalização de obrigações trabalhistas nos contratos com dedicação exclusiva de mão de obra;
4. manutenção da equação econômico-financeira por reajuste, repactuação ou revisão.
...
## 2. Da execução ao pagamento

O pagamento não nasce da simples apresentação da nota fiscal. A cadeia probatória correta é:

1. a contratada executa a prestação;
2. os fiscais acompanham, registram e medem quantidade, qualidade, tempo, modo e resultados;
3. eventuais falhas são corrigidas, justificadas ou refletidas no valor devido;
4. ocorre o recebimento provisório;
5. a documentação é consolidada para o recebimento definitivo;
6. o processo é instruído para liquidação e pagamento;
7. aplicam-se as retenções tributárias que forem legalmente cabíveis.

O art. 92, V e VI, da Lei nº 14.133/2021 exige cláusulas sobre preço e condições de pagamento, critérios e periodicidade do reajustamento, critérios e periodicidade da medição e prazos de liquidação e pagamento. O modelo de gestão também é cláusula necessária, nos termos do inciso XVIII.
...
Contratos orientados a resultados não devem ser medidos apenas pela presença física de empregados. Da mesma forma, um serviço por posto não autoriza ignorar os padrões de qualidade e as demais obrigações contratuais.

## 3. Instrumento de Medição de Resultado

O **Instrumento de Medição de Resultado (IMR)** é o mecanismo que traduz o nível esperado do serviço em indicadores verificáveis. Seu modelo consta do Anexo V-B da IN nº 5/2017, enquanto o Anexo VIII-A disciplina seu uso pela fiscalização técnica.
...
Os critérios devem ser compreensíveis, objetivos, mensuráveis e relacionados ao objeto. Indicadores vagos, criados depois da execução ou dependentes apenas da impressão pessoal do fiscal violam previsibilidade e dificultam contraditório e controle.

### 3.1 Redimensionamento não é sanção automática

O Anexo VIII-A determina redimensionamento do pagamento quando a contratada não produz os resultados, deixa de executar atividades, não atinge a qualidade mínima ou usa recursos em quantidade ou qualidade inferior à exigida. O ajuste busca pagar a contraprestação correspondente ao resultado efetivamente entregue.

Não se confundem:

- **redimensionamento ou glosa:** apura o valor não devido por prestação ausente ou desconforme;
- **sanção:** reage a infração administrativa e depende de previsão, competência, processo, contraditório e ampla defesa;
...
### 3.2 Procedimento mensal do Anexo VIII-A

Durante a execução, o fiscal técnico monitora o nível de qualidade e requer a correção de faltas, falhas e irregularidades. A avaliação é apresentada ao preposto, que toma ciência; a contratada pode justificar nível inferior quando provar ocorrência excepcional decorrente exclusivamente de fatores imprevisíveis e alheios a seu controle.

A avaliação pode ser diária, semanal ou mensal, conforme o período adequado ao objeto. Para efeito do recebimento provisório, porém, ao final de cada período **mensal**, o fiscal técnico apura o conjunto das avaliações, analisa os indicadores e registra em relatório o eventual redimensionamento a ser encaminhado ao gestor.

Desconformidade contínua ou superior aos níveis mínimos toleráveis pode, além dos fatores redutores, fundamentar sanção conforme o edital e o devido processo. É vedado transferir à contratada a própria avaliação que compete à fiscalização.
...
A glosa precisa ser rastreável. Um registro adequado identifica:
...
O art. 143 da Lei nº 14.133/2021 impede que uma controvérsia sobre dimensão, qualidade ou quantidade paralise toda a fatura: a **parcela incontroversa** deve ser liberada no prazo previsto para pagamento. Pagar essa parcela não encerra a apuração do restante nem reconhece o pedido da contratada quanto à parte disputada.

Exemplo: de R$ 100.000 medidos, R$ 8.000 dependem de comprovação e R$ 92.000 são reconhecidos. A Administração deve instruir o pagamento de R$ 92.000 no prazo contratual e continuar a análise documentada dos R$ 8.000.
...
### 6.1 Ordem cronológica e atraso
...
## 7. Fiscalização trabalhista e regularidade
...
Essa hipótese especial explica a intensidade dos controles, mas não transforma a Administração em empregadora nem autoriza ingerência na direção dos empregados. Ordens de serviço devem ser dirigidas ao preposto.

### 7.1 Fiscalização administrativa do Anexo VIII-B

O Anexo VIII-B organiza controles específicos para contratos com dedicação exclusiva. A fiscalização pode usar critérios estatísticos que considerem falhas capazes de afetar o contrato como um todo, sem abandonar a verificação documentada.
...
### 7.2 Regularidade não se confunde com execução
...
- não é conta da Administração, embora sua movimentação seja controlada;
- não é multa nem receita pública;
- não substitui a fiscalização trabalhista;
- não corresponde à retenção tributária;
- não autoriza bloquear indiscriminadamente toda a fatura.

### 8.2 Pagamento pelo fato gerador
...
Para provas que cobrem a IN atualizada, merecem atenção:
...
## 10. Manutenção do equilíbrio econômico-financeiro

A equação econômico-financeira relaciona os encargos assumidos pelo contratado e a remuneração prometida pela Administração na proposta aceita. Sua manutenção não significa assegurar lucro abstrato nem eliminar riscos ordinários do negócio.

Três institutos não devem ser confundidos:
...
### 10.1 Reajuste em sentido estrito

O art. 6º, LVIII, da Lei nº 14.133/2021 define reajuste em sentido estrito como aplicação do índice previsto no contrato, apto a retratar a variação efetiva do custo de produção. Em serviços contínuos sem dedicação exclusiva ou predominância de mão de obra, o art. 92, § 4º, I, determina índices específicos ou setoriais, observado o interregno mínimo de um ano.

O contrato sempre deve estabelecer índice e data-base vinculada ao orçamento estimado. A variação prevista pode ser registrada por apostila, conforme o art. 136, I.
...
As datas são diferentes conforme a parcela:
...
O interregno mínimo é de um ano. A repactuação pode ser dividida em parcelas quando os custos têm anualidades distintas e, havendo várias categorias profissionais, pode acompanhar os diferentes instrumentos coletivos.
...
### 10.3 Prazos e efeitos da repactuação

O art. 57, § 3º, da IN nº 5/2017 contém o prazo histórico de 60 dias, suspenso enquanto faltar documentação. Para os contratos sob a Lei nº 14.133/2021, o art. 92, § 6º, estabelece que o prazo de resposta será **preferencialmente de um mês**, contado do fornecimento da documentação do art. 135, § 6º. Além disso, o contrato deve indicar esse prazo, e a Administração tem o dever geral de decidir requerimentos conforme o art. 123.
...
O art. 124, II, `d`, da Lei nº 14.133/2021 permite restabelecer a equação inicial por acordo em caso de força maior, caso fortuito, fato do príncipe ou fatos imprevisíveis, ou previsíveis de consequências incalculáveis, que inviabilizem a execução tal como pactuada. A matriz contratual de riscos deve ser respeitada.
...
### 10.6 Erro de proposta não é desequilíbrio
...
## 11. Método para resolver questões

Use esta sequência:

1. **Identifique o âmbito:** regra da Lei nº 14.133/2021, disciplina federal da IN ou regulamento local?
2. **Classifique o ato:** medição, recebimento, liquidação, pagamento, glosa, sanção ou retenção tributária?
3. **Localize o risco:** execução ordinária, obrigação trabalhista, evento extraordinário ou risco alocado?
4. **Escolha o mecanismo:** IMR, conta vinculada, fato gerador, reajuste, repactuação ou revisão?
5. **Cheque a prova:** indicador prévio, relatório, planilha, instrumento coletivo, documento fiscal, nexo e memória de cálculo.
6. **Preserve a parcela incontroversa:** divergência parcial não autoriza paralisar tudo.

## 12. Erros recorrentes de prova

- dizer que a nota fiscal, sozinha, prova a execução;
- tratar IMR como multa automática;
