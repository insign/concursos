...
- material verbal: palavras, frases, pontuação e relações entre partes;
- outros modos: imagem, cor, diagramação, gesto, gráfico ou som;
...
Em provas, esta distinção operacional é útil:
...
2. A conclusão é necessária, provável ou apenas possível?
3. A alternativa transformou possibilidade em certeza?
...
| Contradição | Incompatível com o texto |

Em questões de alternativa única, a opção correta costuma ser a mais precisamente autorizada, não a mais interessante ou plausível fora do texto.
...
Compare a alternativa com o texto termo a termo, sobretudo negações, restrições, quantificadores e modalizadores.

### Pressuposição, acarretamento e implicatura

Esses conceitos descrevem formas distintas de conteúdo não inteiramente literal.
...
Pressuposto: o setor publicava relatórios mensais em período anterior. Expressões como **parar de**, **continuar**, **ainda**, **novamente**, **descobrir** e algumas descrições definidas podem funcionar como gatilhos. A análise concreta e o contexto são indispensáveis.
...
Ideias secundárias desenvolvem a principal por meio de:
...
- dado ou testemunho;
- ressalva, concessão ou objeção;
- conclusão parcial.

Uma alternativa erra quando transforma detalhe em síntese, exemplo em tese ou ressalva em posição central.
...
**Fato**, em análise textual, é informação apresentada como verificável: “a reunião ocorreu em 12 de maio”. **Opinião** é avaliação: “a reunião foi improdutiva”. A afirmação pode ser apresentada como fato sem que a prova peça para certificar sua verdade no mundo; o foco é como o texto a formula.
...
- modalizadores: certamente, talvez, infelizmente;
...
### Função de trechos e progressão semântica

Interpretar também é explicar por que uma parte aparece naquele ponto. Um parágrafo pode:

- apresentar o problema;
- especificar uma afirmação geral;
- exemplificar;
- contrastar posições;
- introduzir causa, consequência ou condição;
- formular ressalva;
- responder a objeção;
- concluir ou propor encaminhamento.

Observe a progressão global sem transformar esta análise em mera memorização de conectores. A função decorre da relação de sentido entre as partes.
...
Uma charge que recria pintura conhecida para comentar fato atual depende do diálogo entre textos. Coincidência de assunto, sozinha, não prova intertextualidade. O importante é interpretar o efeito da retomada: reforço, crítica, homenagem, paródia ou atualização.
...
Textos verbais organizam-se principalmente por palavras; não verbais, por imagens, gestos, cores ou outros signos; multimodais ou multissemióticos integram dois ou mais modos.

Em charge, tirinha, anúncio, cartaz, infográfico ou página digital, examine:
...
“Segundo o texto” exige aderência máxima. “Infere-se” autoriza apenas conclusão sustentada. “A finalidade” pede efeito comunicativo predominante. “A função do trecho” exige relacionar parte e conjunto.

### Passo 2: responda antes das alternativas

Resuma mentalmente a ideia principal, tese, inferência ou função. Isso reduz a atração por opções que repetem palavras do texto, mas alteram suas relações.

### Passo 3: localize a prova

Marque negação, quantificador, modalizador, relação temporal, voz citada, dado visual e trecho decisivo. Se não há evidência identificável, a conclusão provavelmente extrapola.

### Passo 4: controle o conhecimento externo

Use repertório para compreender vocabulário e situação, não para substituir o texto. Uma experiência pessoal não invalida dado apenas porque diverge dele.

### Passo 5: elimine distorções

Desconfie de alternativas que:

- generalizam;
- tornam categórico o que era possível;
- convertem sequência temporal em causa;
- atribuem ao autor a fala de terceiro;
- ignoram ressalva ou concessão;
- transformam exemplo em regra;
- trocam fato apresentado por opinião ou vice-versa;
- ignoram imagem, legenda, escala ou fonte;
- começam fiéis e terminam com acréscimo indevido.

## 5. Exemplos integrados

### Inferência limitada

> Das dez unidades avaliadas, seis reduziram o tempo de espera.

É correto concluir que mais da metade reduziu o tempo. É incorreto afirmar que o programa fracassou nas quatro restantes: elas podem ter mantido, aumentado ou não possuir dados comparáveis.

### Voz e concessão

> Especialistas reconhecem que o portal ampliou o acesso. Ainda assim, a mera publicação não garante transparência sem contexto e linguagem clara.

A primeira voz é incorporada como concessão. A tese afirma que acesso material aos dados não basta para torná-los compreensíveis.

### Função de exemplo

> Serviços digitais podem excluir usuários. Por exemplo, formulários que dependem apenas de códigos enviados por celular afastam quem não possui linha ativa.

O segundo período concretiza a afirmação geral. Não substitui o tema nem prova que todo serviço digital exclua.

### Multimodalidade

Em cartaz com “Economize cada gota” sobre uma torneira formando ampulheta, a imagem associa água e tempo. A leitura completa depende da integração entre frase e representação visual.

## 6. Armadilhas finais

1. **Palavra repetida não garante resposta correta.** Relações podem ter sido alteradas.
2. **Plausível não significa autorizado.** A opção precisa de base textual.
3. **Possível não significa necessário.**
...
- PAULIUKONIS, Maria Aparecida Lino; ALVARES, Claudia Assad. **Texto e construção de sentidos: propostas para leitura e interpretação**. *Linha D'Água*, v. 34, n. 1, p. 116-136, 2021. DOI: 10.11606/issn.2236-4242.v34i1p116-136. Disponível no [artigo na revista Linha D'Água](https://revistas.usp.br/linhadagua/pt_BR/article/view/178955). Acesso em: 15 jul. 2026.
- D'ÁVILA, Andressa. **Pressuposição e implicaturas griceanas como mecanismos para o tratamento de usos considerados pressuposicionais de verbos factivos**. *Estudos Linguísticos e Literários*, n. 57, p. 241-261, 2017. DOI: 10.9771/ell.v0i57.24712. Disponível no [artigo na revista Estudos Linguísticos e Literários](https://periodicos.ufba.br/index.php/estudos/article/view/24712). Acesso em: 15 jul. 2026.
