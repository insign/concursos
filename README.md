...
Ativar o primeiro alias ou trocar de alias exige conexão. Antes de alterar o perfil ativo, o navegador lê e valida preferências, todas as respostas do catálogo e progresso; um alias remoto existente é vinculado diretamente após esse preflight. Falhas de rede, validação ou aplicação preservam o alias atual e as pendências locais.
