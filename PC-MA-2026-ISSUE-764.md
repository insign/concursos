...
Estado editorial após o aceite confirmado de U152; PC-E16 — Medicina Legal permanece `pending` com U149–U152 `done` e U153–U155 `pending`; a migração documental anterior permanece apenas como origem deste registro.

| Dimensão | Total | pending | analyzing | done |
|---|---:|---:|---:|---:|
| Unidades reais previstas | 158 | 7 | 0 | 151 |
| Entregáveis de unidade C/H/Q | 474 | 21 | 0 | 453 |
...
Recontagem dos aceites registrados, sem somar macros ou visões: `U001–U074` e `U076–U152` = **151 unidades**. Pendentes: `U075`, `U153–U158` = **7 unidades**. Cada conjunto possui o mesmo estado em C/H/Q nesta consolidação; isso não obriga igualdade de estados em ciclos futuros.

Visões consumidoras registradas: **152 = 135 físicas locais + 17 vínculos canônicos**. U152 acrescentou uma nova visão física local. Não confundir 152 visões materializadas com 151 unidades aceitas. O total de unidades canônicas únicas não deve ser deduzido automaticamente da quantidade de vínculos sem resolver suas origens.

Reservas ativas após o aceite de U152: **nenhuma**. PC-R04 permanece `pending`, com **41/42** parciais aceitas; somente U075 permanece divergente/pendente nessa frente.

**Próxima ação editorial: U153 — Tanatologia forense — morte, fenômenos cadavéricos e cronologia médico-legal**, C/H/Q `pending`. U149–U152 estão `done`; U153–U155 permanecem `pending`.
...
| U149–U152 | Medicina Legal; novas | C/H/Q done; U152 snapshot final `7bfb11cc0b2467d992507aebf3f39e173834dd79`; ver matriz de PC-E16 abaixo |
| U153–U155 | Medicina Legal; novas | C/H/Q pending; planejamento individual materializado em 21/09/2026 sob `PC-E16-PLANEJAMENTO-20260921T0532-01`; ver matriz de PC-E16 abaixo |
...
**Próxima unidade habilitada:** U153 — Tanatologia forense — morte, fenômenos cadavéricos e cronologia médico-legal, C/H/Q `pending`. U149–U152 estão publicados e aceitos.
...
Pacote de **Traumatologia médico-legal — lesões por ação contundente, armas brancas e projéteis**: C/H/Q `done`, **nova/local**, consumidor PC-MA, `storageId: pc-u152`, `order: 152`. Snapshot editorial final `7bfb11cc0b2467d992507aebf3f39e173834dd79`; base reservada `0df7a36b6e07f76452e99c9262e26ae87246f41e`. A comparação base→snapshot confirma **exatamente quatro arquivos novos da U152**, sem alteração lateral. O commit `d653119020773fa2f66fce127281e3436d5b7395` publicou o pacote; `8d4d88e8126f07bde02f797fd4502c44bac0c66d` refinou somente referências; `7bfb11cc0b2467d992507aebf3f39e173834dd79` simplificou somente três termos do conteúdo antes do aceite.

A unidade permanece sem `vinculo.json` e sem doador integral compatível. U149–U151 foram usadas como base conceitual e de método, sem cópia automática; U153 permanece dona de diagnóstico da morte, fenômenos cadavéricos, cronologia e causa jurídica; U154 permanece dona do exame de local. Os anexos disponíveis foram auditados e eram materiais do TCE-MA, sem aderência ao recorte traumático.

Cobertura publicada: mecanismo antes de instrumento; ação contundente com escoriação, equimose, hematoma, víbice, ferida contusa, fraturas e lesões internas; cautela contra datação exata de equimose apenas por cor; armas brancas por mecanismo cortante, perfurante, perfurocortante e cortocontundente; lesões de defesa sem inferência automática de dinâmica; projétil como agente perfurocontundente; energia cinética, energia transferida, cavidades permanente/temporária e alta energia sem corte numérico universal inventado; orla de escoriação, enxugo, tatuagem, esfumaçamento e queimadura; tiro encostado, curta distância e distância maior; buraco de mina de Hoffmann e sinal de Benassi; saída com exceções; trajeto × trajetória; sedenho; interação projétil/osso, fragmentação e ponte mínima para morte traumática. Balística geral, Tanatologia e exame do local não foram duplicados.

Foram publicadas **29 questões: 24 autorais + 5 anteriores verificadas**. As anteriores são adaptações não literais das questões objetivas 24, 35, 37 e 38 do Cebraspe/PC-RO 2022 — Médico-Legista, com gabaritos definitivos D, B, A e C, e da questão 31 da prova oral com padrão oficial sobre tiro a curta distância/cone de explosão. Nenhuma resolução separada foi necessária.

Densidade final: `conteudo.md` **22.858 caracteres**, `cheat-sheet.md` **4.716**, `referencias.md` **7.362** e `questoes.json` **27.537**. Microglossário: **2/0/4 pares `abbr`** em conteúdo/revisão/referências, todos balanceados; o cheat sheet não contém siglas técnicas/institucionais que exijam marcação, e os tokens em caixa alta remanescentes nas referências são iniciais de autores. `questionSetRevision: 1`, **29 IDs únicos**, cinco alternativas por questão, gabaritos existentes e explicações não vazias.

Fontes revalidadas em 21/9/2026: Edital PC-MA; Eze/Ojifinni; Schmidt; Gill/Ely; Grossman et al.; estudo pericial de São Luís/MA; revisões de ferimentos por projétil de arma de fogo de Große Perdekamp/Pollak e Baum et al.; estudo multicêntrico de Manta et al.; prova objetiva, gabarito definitivo e padrão oral Cebraspe/PC-RO 2022. O corte legislativo de 13/7/2026 foi preservado.

**PC-E16 permanece em andamento:** U149–U152 estão C/H/Q `done`; U153–U155 seguem `pending`. Próxima unidade: U153 — Tanatologia forense — morte, fenômenos cadavéricos e cronologia médico-legal.
