...
Estado editorial após o aceite confirmado de U116; PC-E12 permanece concluído e PC-E13 segue em execução; a migração documental anterior permanece apenas como origem deste registro.

| Dimensão | Total | pending | analyzing | done |
|---|---:|---:|---:|---:|
| Unidades reais previstas | 158 | 42 | 0 | 116 |
| Entregáveis de unidade C/H/Q | 474 | 126 | 0 | 348 |
...
Recontagem dos aceites registrados, sem somar macros ou visões: `U001–U074`, `U076–U116` e `U144` = **116 unidades**. Pendentes: `U075`, `U117–U143`, `U145–U158` = **42 unidades**. Cada conjunto possui o mesmo estado em C/H/Q nesta consolidação; isso não obriga igualdade de estados em ciclos futuros.

Visões consumidoras registradas: **118 = 101 físicas locais + 17 vínculos canônicos**. U116 acrescentou uma visão física local; o `grupo.json` de Direito Constitucional permanece estrutural e não é visão nem unidade. Não confundir 118 visões materializadas com 116 unidades aceitas. O total de unidades canônicas únicas não deve ser deduzido automaticamente da quantidade de vínculos sem resolver suas origens.
...
**Próxima ação editorial: U117 — Poder Executivo — atribuições e responsabilidades do Presidente da República**, C/H/Q `pending`. U116 foi concluída; PC-E13-C/H/Q permanece `pending` como macro enquanto U117–U122 não forem concluídas.
...
**Ordem habilitada:** U117 é a primeira unidade pendente de PC-E13. U112–U116 estão publicadas; seguir U117–U122, salvo dependência material comprovada ou pedido explícito.
...
Esta seção substitui relatos repetidos de reserva, publicação e totais. **São evidências recebidas**, não uma declaração de releitura integral de todos esses artefatos nesta migração. Os commits identificam as versões publicadas e permitem ler o conjunto completo de fontes e decisões editoriais; não dependem de comentários ou de versões anteriores da issue.
...
Pacote de Administração pública e servidores públicos na Constituição: C/H/Q `done`, nova/local, consumidor PC-MA, `storageId: pc-u116`, `order: 116`. Snapshot editorial final `9e45c836d08eac0783ccabfae275d3b6c76f1e54`; base de publicação `605bc82ec40b973a4000b10aed4e472545614eef`. A comparação base→snapshot confirma **exatamente quatro arquivos da U116**, sem alterações laterais: `conteudo.md`, `cheat-sheet.md`, `referencias.md` e `questoes.json`. A base já continha commits alheios posteriores a U115, que foram preservados integralmente.

A unidade permanece **nova/local**, sem `vinculo.json`. O apoio físico principal do TCE-MA, `conhecimentos-gerais/direito-constitucional/administracao-publica-servidores-publicos/` (árvore `1bf5080b4c7edbb3b1ae013fa813b812b68d0f3d`), foi auditado integralmente, com apoio complementar do pacote de Noções `administracao-publica-disposicoes-gerais-servidores-publicos/`. O recorte foi mantido no patamar constitucional dos arts. 37–41, com art. 169 apenas na hipótese de redução de despesa com pessoal. U100 continua responsável pela Lei 8.112/1990, U109 pelo regime geral dos servidores maranhenses e U108 pelo estatuto policial; prazos, licenças, deveres e penalidades desses diplomas não foram tratados como comandos constitucionais.

Foram publicadas **22 questões — 20 autorais + 2 adaptações não literais verificadas**. A primeira deriva da questão 15 da prova Cebraspe SEFA-PR 2026 para Agente Fazendário Estadual, gabarito definitivo E, sobre princípios e organização da Administração indireta. A segunda deriva da questão 76 da prova FGV TCE-SC 2026 para Auditor Fiscal de Controle Externo — Direito, gabarito definitivo A, sobre ocupante exclusivo de cargo em comissão sujeito ao Regime Geral de Previdência Social.

Recorte coberto: princípios expressos do art. 37; acesso e concurso; funções de confiança e cargos em comissão; contratação temporária; sindicalização, greve e publicidade institucional; remuneração, teto, subtetos e parcelas indenizatórias; acumulação de vínculos; criação de entidades da Administração indireta; licitação como ponte constitucional; participação do usuário, improbidade, responsabilidade civil, contrato de desempenho e readaptação; mandato eletivo do art. 38; política de pessoal e subsídio do art. 39; regimes previdenciários e aposentadorias do art. 40; estabilidade, perda do cargo, reintegração, recondução e disponibilidade do art. 41, além da hipótese do art. 169, § 4º.

A auditoria normativa incorporou a **Emenda Constitucional 138/2025**, que alterou o art. 37, XVI, b, para permitir um cargo de professor com outro de qualquer natureza, preservadas compatibilidade de horários e teto; e a **Emenda Constitucional 135/2024**, especialmente o art. 37, § 11, sobre parcelas indenizatórias e teto. O julgamento da **ADI 2.135** foi incorporado com seu efeito material: a Constituição não exige atualmente regime jurídico único, e a decisão não muda automaticamente o regime dos servidores atuais. A Emenda Constitucional 139/2026 não alterou os arts. 37–41. A jurisprudência concluída em 30/6/2026 sobre determinadas parcelas indenizatórias do Judiciário e Ministério Público foi registrada como fronteira específica, sem projetá-la sobre a Polícia Civil estadual.

Fontes revalidadas: Constituição Federal compilada; Emendas Constitucionais 19/1998, 103/2019, 135/2024, 138/2025 e 139/2026; Lei Complementar 152/2015; Supremo Tribunal Federal na ADI 2.135 e nos julgamentos de teto/parcelas indenizatórias de 2026; prova e gabarito Cebraspe SEFA-PR 2026; prova e gabarito FGV TCE-SC 2026. O corte legislativo permanece em **13/7/2026**; a regra jurisprudencial do edital continua separada e sujeita à revalidação final da campanha.

Microglossário: conteúdo, revisão rápida e referências foram auditados para siglas/abreviações renderizadas; as marcações `abbr` estão balanceadas. A inspeção final não encontrou siglas residuais não marcadas fora de código, URLs ou campos puros. Conceitos como readaptação, regime próprio, regime geral, equilíbrio atuarial, estabilidade, reintegração, recondução e disponibilidade são ensinados antes ou no ponto de uso. O JSON permanece em texto puro.

Próxima unidade habilitada: U117 — Poder Executivo — atribuições e responsabilidades do Presidente da República.
