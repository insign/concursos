...
**Próxima ação editorial: U112 — Estado e Constituição — conceito, conteúdo, objeto e classificação**, C/H/Q `pending`. O planejamento executável de PC-E13 — Direito Constitucional (U112–U122) foi materializado abaixo com decisão editorial nova, sem restaurar divisão histórica perdida. O grupo `direito-constitucional` será publicado junto ao primeiro pacote completo de U112, evitando grupo vazio. U111 e PC-E12-C/H/Q permanecem `done`.
...
Grupo planejado, ainda **não publicado para evitar estrutura vazia**: `conhecimentos-especificos/direito-constitucional/`, título `Direito Constitucional`, ordem 4. Publicar seu `grupo.json` junto ao primeiro pacote completo de U112. Consumidor comum: `pc-ma-2026-oficial-investigador` / `pcma-2026-invest`. Identidades `pc-u112`–`pc-u122`, ordens 112–122. Destinos: prefixo físico PC-MA + grupo + slug.
...
**Ordem habilitada:** U112 é a primeira unidade pendente de PC-E13. Não há dependência estrutural anterior não concluída. O ciclo de U112 deve publicar também o `grupo.json` de Direito Constitucional; depois seguir U113–U122, salvo dependência material comprovada ou pedido explícito.
