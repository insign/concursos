...
Estado editorial recebido após U093; a migração documental não o modifica.

| Dimensão | Total | pending | analyzing | done |
|---|---:|---:|---:|---:|
| Unidades reais previstas | 158 | 64 | 0 | 94 |
| Entregáveis de unidade C/H/Q | 474 | 192 | 0 | 282 |
...
Recontagem dos aceites registrados, sem somar macros ou visões: `U001–U074`, `U076–U093`, `U101` e `U144` = **94 unidades**. Pendentes: `U075`, `U094–U100`, `U102–U143`, `U145–U158` = **64 unidades**. Cada conjunto possui o mesmo estado em C/H/Q nesta consolidação; isso não obriga igualdade de estados em ciclos futuros.

Visões consumidoras registradas: **96 = 79 físicas locais + 17 vínculos canônicos**. É o inventário aceito na campanha, transferido sem nova auditoria integral da árvore. Não confundir 96 visões materializadas com 94 unidades aceitas. O total de unidades canônicas únicas não deve ser deduzido automaticamente da quantidade de vínculos sem resolver suas origens.
...
**Próxima ação editorial: U094 — Prisão em flagrante**, C/H/Q `pending`, após concluir e confirmar esta migração documental. Nenhuma produção U094 integra esta intervenção.
...
| 4, primeira ocorrência | U094 — Prisão em flagrante — `prisao-flagrante` | Depende de U091; separar captura em flagrante de fundamento autônomo de preventiva | pending | pending | pending |
...
Pacote de Prova no processo penal, artigos 158–250: C/H/Q `done`, nova/local, consumidor PC-MA, `storageId: pc-u093`, `order: 93`. Commit editorial `1417796d9e09f3fec1db28a30a153577a3b37cf4`, seguido da formatação do JSON no commit `20ff4172c93b0ca6f04edf5f55c5604e027d881f`. Base `948e60afc095cc9fa964d2e2358af2a21eb728b7`. O aceite registrou apenas quatro arquivos novos, 22 questões, sem resoluções, e 16 marcações `abbr` balanceadas.

Fontes indicadas no aceite: Código de Processo Penal, Constituição, Resolução 484 do Conselho Nacional de Justiça, Tema 1.258, Habeas Corpus 1.085.352 e Inquérito 1.674 do Superior Tribunal de Justiça, e Tema 280 do Supremo Tribunal Federal. O registro sintético fixou 13/7/2026 como corte; a distinção temporal pendente está na seção 2. Não interpretar este resumo administrativo como correção ou revalidação das fontes.
