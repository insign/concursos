...
Estado editorial após o aceite confirmado de U143; PC-E14 — Legislação Especial está concluído e PC-E15 — Direitos Humanos permanece `pending`; a migração documental anterior permanece apenas como origem deste registro.

| Dimensão | Total | pending | analyzing | done |
|---|---:|---:|---:|---:|
| Unidades reais previstas | 158 | 15 | 0 | 143 |
| Entregáveis de unidade C/H/Q | 474 | 45 | 0 | 429 |
...
Recontagem dos aceites registrados, sem somar macros ou visões: `U001–U074` e `U076–U144` = **143 unidades**. Pendentes: `U075`, `U145–U158` = **15 unidades**. Cada conjunto possui o mesmo estado em C/H/Q nesta consolidação; isso não obriga igualdade de estados em ciclos futuros.

Visões consumidoras registradas: **144 = 127 físicas locais + 17 vínculos canônicos**. U143 acrescentou uma nova visão física local; U142 e U144 já estavam materializadas antes deste ciclo. Não confundir 144 visões materializadas com 143 unidades aceitas. O total de unidades canônicas únicas não deve ser deduzido automaticamente da quantidade de vínculos sem resolver suas origens.

Reservas ativas após o aceite de U143: **nenhuma**. PC-R04 permanece `pending`, com **41/42** parciais aceitas; somente U075 permanece divergente/pendente nessa frente.

**Próxima ação editorial: U145 — Pactos Internacionais de 1966 — direitos civis e políticos; direitos econômicos, sociais e culturais**, C/H/Q `pending`, conforme o planejamento individual de PC-E15. U142–U144 estão `done`; U145–U148 seguem `pending`.
...
| U145–U148 | Direitos Humanos; novas | C/H/Q pending; planejamento individual materializado em 20/09/2026 sob `PC-E15-PLANEJAMENTO-20260920-01`; ver matriz de PC-E15 abaixo |
...
**Ordem habilitada após o aceite de U143:** U145 → U146 → U147 → U148; U144 permanece `done`. A sequência preserva pré-requisitos: sistema global antes dos Pactos, sistema interamericano antes do controle de convencionalidade e fundamentos antes da aplicação policial.
...
**Próxima unidade habilitada:** U145, C/H/Q `pending`. PC-E15-C/H/Q permanece `pending` até U145–U148 serem concluídas; U142–U144 estão `done`.
...
Pacote de **Direito internacional dos direitos humanos e direito brasileiro — incorporação, hierarquia e relações internacionais**: C/H/Q `done`, **nova/local**, consumidor PC-MA, `storageId: pc-u143`, `order: 143`. Snapshot editorial final `718e9a5d27f145f521b91b5db93bafb3bb635128`; base reservada `c9680feed18ca78a1c26127ab43e78bc623f4829`. A comparação base→snapshot confirma **exatamente quatro arquivos novos da U143**, sem alteração lateral: `conteudo.md`, `cheat-sheet.md`, `referencias.md` e `questoes.json`.

A unidade permanece **nova/local**, sem `vinculo.json` e sem doador integral compatível. Foram lidos integralmente o canônico `nocoes-direitos-humanos/teoria-geral-direitos-fundamentais/` e os apoios U142, U113 e U114. O canônico forneceu somente a ponte sobre artigo 5º, §§ 2º–3º, duplo estatuto e depositário infiel; U113 já ensina o artigo 4º integralmente; U114 cobre os parágrafos constitucionais e o efeito do precedente no recorte de direitos fundamentais. Nenhum desses materiais foi alterado.

Cobertura publicada: relação entre plano internacional e direito interno; Convenção de Viena e distinção entre responsabilidade internacional e hierarquia doméstica; celebração presidencial, aprovação congressual, ratificação, entrada em vigor e promulgação/executoriedade; rito qualificado do artigo 5º, § 3º; equivalência a emenda; supralegalidade conforme RE 466.343/STF; Súmula Vinculante 25; exemplos oficiais de tratados aprovados pelo § 3º; e os princípios do artigo 4º em revisão comprimida. A redação literal peculiar do item 2.3 — **“hierarquia dos tratados de direitos fundamentais”** — foi preservada e contextualizada, sem correção silenciosa.

Foram publicadas **26 questões: 24 autorais + 2 anteriores verificadas**, sem quota artificial. As anteriores são adaptações não literais da questão 86 do Cebraspe/PC-RO 2022, Médico-Legista, gabarito definitivo A, e do item 45 do Cebraspe/ANATEL 2024, gabarito definitivo Errado. A prova oral DPE-AC 2024 foi consultada como evidência de incidência, mas não importada porque avançava para controle de convencionalidade, reservado à U147. Nenhuma resolução separada foi necessária.

Densidade final: `conteudo.md` com **19.617 caracteres**, `cheat-sheet.md` com **4.355**, `referencias.md` com **8.871** e `questoes.json` com **27.170**. Microglossário final: **16 pares `abbr` no conteúdo e 5 no cheat sheet**, balanceados, sem títulos vazios ou aninhamento; as referências não mantêm siglas técnicas renderizadas fora de nomes/identificadores que exijam marcação, e o JSON permanece texto puro. `questionSetRevision: 1`, **26 IDs únicos**, cinco alternativas por questão, gabaritos apontando para opções existentes e explicações não vazias.

**PC-E15 permanece em andamento:** U142–U144 estão C/H/Q `done`; U145–U148 seguem `pending`. A próxima unidade habilitada é U145 — Pactos Internacionais de 1966 — direitos civis e políticos; direitos econômicos, sociais e culturais.
