...
Estado editorial após o aceite confirmado de U147; PC-E14 — Legislação Especial está concluído e PC-E15 — Direitos Humanos permanece `pending`; a migração documental anterior permanece apenas como origem deste registro.

| Dimensão | Total | pending | analyzing | done |
|---|---:|---:|---:|---:|
| Unidades reais previstas | 158 | 12 | 0 | 146 |
| Entregáveis de unidade C/H/Q | 474 | 36 | 0 | 438 |
...
Recontagem dos aceites registrados, sem somar macros ou visões: `U001–U074` e `U076–U147` = **146 unidades**. Pendentes: `U075`, `U148–U158` = **12 unidades**. Cada conjunto possui o mesmo estado em C/H/Q nesta consolidação; isso não obriga igualdade de estados em ciclos futuros.

Visões consumidoras registradas: **147 = 130 físicas locais + 17 vínculos canônicos**. U147 acrescentou uma nova visão física local. Não confundir 147 visões materializadas com 146 unidades aceitas. O total de unidades canônicas únicas não deve ser deduzido automaticamente da quantidade de vínculos sem resolver suas origens.

Reservas ativas após o aceite de U147: **nenhuma**. PC-R04 permanece `pending`, com **41/42** parciais aceitas; somente U075 permanece divergente/pendente nessa frente.

**Próxima ação editorial: U148 — Proteção de grupos vulneráveis e direitos humanos na atividade policial**, C/H/Q `pending`, conforme o planejamento individual de PC-E15. U142–U147 estão `done`; U148 segue `pending`.
...
| U148 | Direitos Humanos; nova; `grupos-vulneraveis-atividade-policial-direitos-humanos` | C/H/Q pending; planejamento individual materializado em 20/09/2026 sob `PC-E15-PLANEJAMENTO-20260920-01`; ver matriz de PC-E15 abaixo |
...
**Ordem habilitada após o aceite de U147:** U148. A sequência preserva pré-requisitos: fundamentos de direitos humanos e convencionalidade antes da aplicação policial.
...
**Próxima unidade habilitada:** U148, C/H/Q `pending`. PC-E15-C/H/Q permanece `pending` até U148 ser concluída; U142–U147 estão `done`.
...
Pacote de **Controle de convencionalidade e direitos humanos na Constituição Federal de 1988**: C/H/Q `done`, **nova/local**, consumidor PC-MA, `storageId: pc-u147`, `order: 147`. Snapshot editorial final `017f1aadec3af39d105dbfc125f97c89827c94cf`; base reservada `60dec40ddca0520b33e841a5993d7470c19fbf47`. A comparação base→snapshot confirma **exatamente quatro arquivos novos da U147**, sem alteração lateral: `conteudo.md`, `cheat-sheet.md`, `referencias.md` e `questoes.json`.

A unidade permanece **nova/local**, sem `vinculo.json` e sem doador integral compatível. U143 permanece responsável por incorporação, ratificação/promulgação e hierarquia; U146, pela arquitetura OEA/CADH, Comissão e Corte; U113/U114 fornecem as âncoras constitucionais de dignidade, princípios e artigo 5º. U147 reutiliza apenas as pontes necessárias e não altera nenhuma dessas unidades. U148 permanece responsável pela proteção de grupos vulneráveis e aplicação à atividade policial.

Cobertura publicada: conceito e fundamentos do controle de convencionalidade; artigos 1º–2º da CADH e artigos 26–27 da Convenção de Viena; evolução jurisprudencial interamericana a partir de Almonacid, exercício de ofício dentro das competências/regras processuais e ampliação aos órgãos/autoridades estatais; atos comissivos/omissivos e parâmetro aplicável; matrizes nacional/interna e internacional; cautela com os rótulos difuso/concentrado; controle de constitucionalidade × convencionalidade; duplo estatuto × duplo controle; efeito interno de tratados equivalentes a emenda e supralegais; distinção entre hierarquia interna e responsabilidade internacional; e âncoras constitucionais dos artigos 1º, III; 4º, II; 5º, §§ 1º–4º; e 60, § 4º, IV.

Foram publicadas **26 questões: 24 autorais + 2 anteriores verificadas**, sem quota artificial. As anteriores são adaptações não literais do Ponto 1 da prova oral Cebraspe/DPE-AC 2024, cujo padrão distingue as matrizes nacional e internacional, e do item 86 do Cebraspe/TRF6 2025 — Agente da Polícia Judicial, gabarito definitivo Errado, sobre a falsa submissão, no controle nacional, de norma constitucional originária a tratado de direitos humanos supralegal. Nenhuma resolução separada foi necessária.

Densidade final: `conteudo.md` com **24.697 caracteres**, `cheat-sheet.md` com **4.841**, `referencias.md` com **7.863** e `questoes.json` com **27.960**. Microglossário final: **23 pares `abbr` no conteúdo, 10 no cheat sheet e 3 nas referências**, todos balanceados, sem títulos vazios; os materiais didáticos não mantêm CADH/STF/TPI/TRF6 nus, e o JSON permanece texto puro. `questionSetRevision: 1`, **26 IDs únicos**, cinco alternativas por questão, gabaritos apontando para opções existentes e explicações não vazias.

A inspeção pós-publicação retirou do cheat sheet uma menção ao artigo 29 da CADH que não era ensinada na aula e estreitou a referência correspondente, evitando introduzir fundamento novo na revisão. Corte e fontes: Constituição compilada, CADH, Convenção de Viena, fichas/caderno/Themis da Corte Interamericana, Recurso Extraordinário 466.343, Súmula Vinculante 25 e provas/padrões oficiais Cebraspe foram revalidados em 21/9/2026. A consulta posterior ao edital foi usada para conferência documental; não importou alteração legislativa posterior ao corte de 13/7/2026.

**PC-E15 permanece em andamento:** U142–U147 estão C/H/Q `done`; U148 segue `pending`. A próxima unidade habilitada é U148 — Proteção de grupos vulneráveis e direitos humanos na atividade policial.
