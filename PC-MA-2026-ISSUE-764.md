...
Estado editorial após o aceite confirmado de U145; PC-E14 — Legislação Especial está concluído e PC-E15 — Direitos Humanos permanece `pending`; a migração documental anterior permanece apenas como origem deste registro.

| Dimensão | Total | pending | analyzing | done |
|---|---:|---:|---:|---:|
| Unidades reais previstas | 158 | 14 | 0 | 144 |
| Entregáveis de unidade C/H/Q | 474 | 42 | 0 | 432 |
...
Recontagem dos aceites registrados, sem somar macros ou visões: `U001–U074` e `U076–U145` = **144 unidades**. Pendentes: `U075`, `U146–U158` = **14 unidades**. Cada conjunto possui o mesmo estado em C/H/Q nesta consolidação; isso não obriga igualdade de estados em ciclos futuros.

Visões consumidoras registradas: **145 = 128 físicas locais + 17 vínculos canônicos**. U145 acrescentou uma nova visão física local. Não confundir 145 visões materializadas com 144 unidades aceitas. O total de unidades canônicas únicas não deve ser deduzido automaticamente da quantidade de vínculos sem resolver suas origens.

Reservas ativas após o aceite de U145: **nenhuma**. PC-R04 permanece `pending`, com **41/42** parciais aceitas; somente U075 permanece divergente/pendente nessa frente.

**Próxima ação editorial: U146 — Sistema Interamericano de Direitos Humanos — OEA, Convenção Americana, Comissão e Corte**, C/H/Q `pending`, conforme o planejamento individual de PC-E15. U142–U145 estão `done`; U146–U148 seguem `pending`.
...
| U146–U148 | Direitos Humanos; novas | C/H/Q pending; planejamento individual materializado em 20/09/2026 sob `PC-E15-PLANEJAMENTO-20260920-01`; ver matriz de PC-E15 abaixo |
...
**Ordem habilitada após o aceite de U145:** U146 → U147 → U148. A sequência preserva pré-requisitos: sistema interamericano antes do controle de convencionalidade e fundamentos antes da aplicação policial.
...
**Próxima unidade habilitada:** U146, C/H/Q `pending`. PC-E15-C/H/Q permanece `pending` até U146–U148 serem concluídas; U142–U145 estão `done`.
...
Pacote de **Pactos Internacionais de 1966 — direitos civis e políticos; direitos econômicos, sociais e culturais**: C/H/Q `done`, **nova/local**, consumidor PC-MA, `storageId: pc-u145`, `order: 145`. Snapshot editorial final `00ee81d6fcf57d5c3184ebd1e661598fefa01f61`; base reservada `0157f60aa7f6f1a722b9b18c5a09315caaa91263`. A comparação base→snapshot confirma **exatamente quatro arquivos novos da U145**, sem alteração lateral: `conteudo.md`, `cheat-sheet.md`, `referencias.md` e `questoes.json`.

A unidade permanece **nova/local**, sem `vinculo.json` e sem doador integral. U144 foi lida integralmente e permanece responsável pela arquitetura da ONU e pela DUDH; U143 foi lida integralmente e permanece responsável por incorporação, ratificação/promulgação e hierarquia brasileira. O canônico `nocoes-direitos-humanos/declaracao-universal-direitos-humanos/` foi tratado somente como fronteira temática, não como origem física. Nenhuma dessas unidades/origens foi alterada.

Cobertura publicada: artigo 1º comum e autodeterminação; obrigações do PIDCP de respeitar/garantir e assegurar recurso efetivo; obrigação do PIDESC de adotar medidas até o máximo dos recursos disponíveis para realização progressiva; não discriminação e igualdade; direitos civis/políticos por blocos; derrogação do artigo 4º e núcleo não derrogável; trabalho, segurança social, nível de vida, saúde, educação, cultura e ciência; e mecanismos de monitoramento. Foi destacada a diferença institucional de prova: o PIDCP cria o Comitê de Direitos Humanos; o texto originário do PIDESC remete relatórios ao Conselho Econômico e Social, e o Comitê de Direitos Econômicos, Sociais e Culturais foi criado em 1985. Protocolos facultativos aparecem apenas para impedir a falsa conclusão de que comunicações individuais sejam automáticas.

Foram publicadas **26 questões: 24 autorais + 2 anteriores verificadas**, sem quota artificial. As anteriores são adaptações não literais da questão 96 do Cebraspe/PGE-PA 2023, gabarito definitivo B, sobre realização progressiva no PIDESC, e da questão 13 do Cespe/UnB/DPE-RO 2012, gabarito definitivo E, sobre restrições admissíveis ao direito de reunião no PIDCP. Nenhuma resolução separada foi necessária.

Densidade final: `conteudo.md` com **26.141 caracteres**, `cheat-sheet.md` com **5.416**, `referencias.md` com **8.084** e `questoes.json` com **27.802**. Microglossário final: **46 pares `abbr` no conteúdo, 14 no cheat sheet e 1 nas referências**, todos balanceados, sem títulos vazios ou aninhamento; o JSON permanece texto puro. `questionSetRevision: 1`, **26 IDs únicos**, cinco alternativas por questão, gabaritos apontando para opções existentes e explicações não vazias.

Corte e fontes: Decretos nº 591/1992 e nº 592/1992, textos oficiais das Nações Unidas, artigo 40 do PIDCP e Resolução ECOSOC 1985/17 foram revalidados em 20/9/2026. Ambos os Pactos registram, para o Brasil, aprovação pelo Decreto Legislativo nº 226/1991, depósito da adesão em 24/1/1992, entrada em vigor em 24/4/1992 e promulgação em 6/7/1992.

**PC-E15 permanece em andamento:** U142–U145 estão C/H/Q `done`; U146–U148 seguem `pending`. A próxima unidade habilitada é U146 — Sistema Interamericano de Direitos Humanos — OEA, Convenção Americana, Comissão e Corte.
