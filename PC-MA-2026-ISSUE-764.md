...
Estado editorial após o aceite confirmado de U118; PC-E12 permanece concluído e PC-E13 segue em execução; a migração documental anterior permanece apenas como origem deste registro.

| Dimensão | Total | pending | analyzing | done |
|---|---:|---:|---:|---:|
| Unidades reais previstas | 158 | 40 | 0 | 118 |
| Entregáveis de unidade C/H/Q | 474 | 120 | 0 | 354 |
...
Recontagem dos aceites registrados, sem somar macros ou visões: `U001–U074`, `U076–U118` e `U144` = **118 unidades**. Pendentes: `U075`, `U119–U143`, `U145–U158` = **40 unidades**. Cada conjunto possui o mesmo estado em C/H/Q nesta consolidação; isso não obriga igualdade de estados em ciclos futuros.

Visões consumidoras registradas: **120 = 103 físicas locais + 17 vínculos canônicos**. U118 acrescentou uma visão física local; o `grupo.json` de Direito Constitucional permanece estrutural e não é visão nem unidade. Não confundir 120 visões materializadas com 118 unidades aceitas. O total de unidades canônicas únicas não deve ser deduzido automaticamente da quantidade de vínculos sem resolver suas origens.
...
**Próxima ação editorial: U119 — Poder Judiciário — disposições gerais**, C/H/Q `pending`. U118 foi concluída; PC-E13-C/H/Q permanece `pending` como macro enquanto U119–U122 não forem concluídas.
...
**Ordem habilitada:** U119 é a primeira unidade pendente de PC-E13. U112–U118 estão publicadas; seguir U119–U122, salvo dependência material comprovada ou pedido explícito.
...
Pacote de Poder Legislativo — estrutura, funcionamento e atribuições: C/H/Q `done`, nova/local, consumidor PC-MA, `storageId: pc-u118`, `order: 118`. Snapshot editorial final `1f81b6c035c1f6d7bd175fd2c33dd9a9fcc57d6b`; base de publicação `e3548e7b0bc07c2852bef98efcfd77e6771f45cb`. A comparação base→snapshot confirma **exatamente quatro arquivos da U118**, sem alterações laterais: `conteudo.md`, `cheat-sheet.md`, `referencias.md` e `questoes.json`.

A unidade permanece **nova/local**, sem `vinculo.json`. O apoio físico do TCE-MA `conhecimentos-gerais/direito-constitucional/poder-legislativo/` (árvore `8b358ec43917b9f6781025fc8d989aa570bbfc1a`) foi auditado integralmente. Como o doador cobre também processo legislativo, fiscalização contábil/financeira/orçamentária e jurisprudência extensa de comissões parlamentares de inquérito, o reaproveitamento foi seletivo: U118 concentra os arts. 44–58; processo legislativo dos arts. 59–69 e controle dos arts. 70–75 foram excluídos, e a comissão parlamentar de inquérito ficou apenas no núcleo literal do art. 58, § 3º.

Foram publicadas **22 questões — 21 autorais + 1 adaptação não literal verificada**. A anterior deriva do item 103 da prova Cebraspe Câmara dos Deputados 2026, Cargo 1 — Analista Legislativo, especialidade Processo Legislativo e Gestão, aplicação de 8/3/2026, com gabarito oficial definitivo E. A adaptação preserva o núcleo do art. 48, III, sobre fixação e modificação dos efetivos das Forças Armadas, sem reproduzir o enunciado original.

Recorte coberto: bicameralismo; legislatura; representação, composição, mandatos e renovação da Câmara e do Senado; regra geral de deliberação; sessão legislativa ordinária; Mesas e sessões conjuntas; convocação extraordinária em nível funcional; comissões permanentes e temporárias; núcleo constitucional das comissões parlamentares de inquérito; distinção entre arts. 48, 49, 51 e 52; competências legislativas do Congresso, competências exclusivas do Congresso, fiscalização por informações, competências privativas da Câmara e do Senado; inviolabilidade, prisão parlamentar e fronteira mínima de incompatibilidades/perda de mandato.

Fontes revalidadas: Edital nº 1 da PC-MA, item 20.2.3, Direito Constitucional, itens 8, 8.1 e 8.2; Constituição Federal compilada, especialmente arts. 44–58; Emenda Constitucional nº 139/2026 como controle temporal sem alteração desse núcleo; caderno e gabarito definitivo Cebraspe Câmara dos Deputados 2026. O corte legislativo permanece em **13/7/2026**.

Densidade: o texto visível local ficou em aproximadamente **18,2 mil caracteres**, contra **25,4 mil** do doador, redução de cerca de 28% coerente com a retirada dos blocos fora do recorte. Microglossário: as siglas/abreviações institucionais renderizadas foram evitadas por escrita por extenso ou marcadas com `abbr`; as marcações estão balanceadas. A inspeção residual encontrou apenas algarismos romanos e identificadores U117/U118 ou PC-E13/PC-R02, que não recebem marcação. O JSON permanece em texto puro. Não foram criadas resoluções separadas, pois as explicações das questões são suficientes.

Próxima unidade habilitada: U119 — Poder Judiciário — disposições gerais.
