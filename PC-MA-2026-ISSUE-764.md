...
Estado editorial após o aceite confirmado de U137; PC-E13 — Direito Constitucional está concluído e PC-E14 — Legislação Especial está em andamento; a migração documental anterior permanece apenas como origem deste registro.

| Dimensão | Total | pending | analyzing | done |
|---|---:|---:|---:|---:|
| Unidades reais previstas | 158 | 21 | 0 | 137 |
| Entregáveis de unidade C/H/Q | 474 | 63 | 0 | 411 |
...
Recontagem dos aceites registrados, sem somar macros ou visões: `U001–U074`, `U076–U137` e `U144` = **137 unidades**. Pendentes: `U075`, `U138–U143`, `U145–U158` = **21 unidades**. Cada conjunto possui o mesmo estado em C/H/Q nesta consolidação; isso não obriga igualdade de estados em ciclos futuros.

Visões consumidoras registradas: **139 = 122 físicas locais + 17 vínculos canônicos**. U137 acrescentou uma visão física local; o `grupo.json` de Legislação Especial permanece estrutural e não é visão nem unidade. Não confundir 139 visões materializadas com 137 unidades aceitas. O total de unidades canônicas únicas não deve ser deduzido automaticamente da quantidade de vínculos sem resolver suas origens.

Reservas ativas após o aceite de U137: **nenhuma**. PC-R04 permanece `pending`, com **40/42** parciais aceitas. U075 permanece divergente e U142 permanece `pending`.

**Próxima ação editorial: U138 — Crimes eleitorais — Lei 4.737/1965**, C/H/Q `pending`, conforme o planejamento individual de PC-E14. U123–U137 estão C/H/Q `done`; PC-E14-C/H/Q permanece `pending` enquanto U138–U141 não forem concluídas.
...
**Ordem habilitada:** U138 é a primeira unidade pendente de PC-E14. U123–U137 estão C/H/Q `done`; U138–U141 permanecem C/H/Q `pending`. PC-E14-C/H/Q continua `pending` até a conclusão de todas as unidades do bloco.
...
Pacote de **Crimes de trânsito — Lei nº 9.503/1997**: C/H/Q `done`, nova/local, consumidor PC-MA, `storageId: pc-u137`, `order: 137`. Snapshot editorial final `0ddbfa13780ee040563048fdc716998c39856b1f`; base reservada `6d45d50cb7bff192553784a3255e46f5a06d7c1e`. A comparação base→snapshot confirma **exatamente quatro arquivos da U137**, sem alteração lateral: `conteudo.md`, `cheat-sheet.md`, `referencias.md` e `questoes.json`.

A unidade permanece **nova/local**, sem `vinculo.json`. A busca no acervo localizou apenas referências incidentais ao Código de Trânsito Brasileiro, sem pacote físico ou canônico integral compatível com o Capítulo XIX. U135 foi usada somente como ponte ao regime da Lei nº 9.099/1995; U091–U097 permanecem responsáveis pela teoria geral do processo penal.

Corte legislativo de **13/7/2026** reconstruído com o Código de Trânsito Brasileiro compilado e os diplomas modificadores pertinentes. A Lei nº 14.599/2023 já havia incorporado “sinistro de trânsito” e redações correlatas. A Lei nº 15.153/2025, a Lei nº 15.428/2026, a Medida Provisória nº 1.360/2026 — vigente no corte — e a Lei nº 15.452/2026 foram auditadas e não modificaram materialmente os artigos 291–312-B. Alterações posteriores ao corte não foram incorporadas.

Cobertura organizada: integração com Código Penal/Processo Penal e Lei nº 9.099/1995; exceções da lesão culposa; suspensão/proibição, cautelar, comunicação e reincidência; multa reparatória; agravantes; socorro e flagrante; homicídio/lesão culposos e formas ligadas ao álcool; omissão e fuga; embriaguez e meios de prova; violação de suspensão; corrida/manobra; direção sem habilitação; entrega de direção; velocidade incompatível; inovação artificiosa; prestação de serviços e artigo 312-B.

Jurisprudência oficial revalidada: Tema 907/STF sobre constitucionalidade do artigo 305; Súmula 575/STJ sobre perigo abstrato no artigo 310; Súmula 664/STJ sobre ausência de consunção entre artigos 306 e 309; Informativo 893/STJ, de junho de 2026, sobre perigo abstrato, autonomia da persecução penal e meios de prova do artigo 306; e Informativo 623/STJ sobre impossibilidade de presumir dolo eventual somente pela embriaguez.

Foram publicadas **42 questões: 40 autorais + 2 anteriores verificadas**. As anteriores são adaptações não literais da questão 31 da DPE-AC/Cebraspe 2017, gabarito definitivo C, sobre o artigo 310 como perigo abstrato, e da questão 4 da prova oral PC-PE/Cebraspe 2023, cujo padrão oficial afasta consunção entre embriaguez e direção sem habilitação. A questão 19 do MP-AP/Cebraspe 2021 foi localizada, mas descartada porque o gabarito definitivo oficial a anulou. Nenhuma resolução separada foi necessária.

Densidade final: `conteudo.md` com **23.758 caracteres** e `cheat-sheet.md` com **4.590**. Microglossário pós-inspeção: **19 pares `abbr` no conteúdo e 6 no cheat sheet, todos balanceados**; abreviações jurídicas foram expandidas e não restaram siglas técnicas/institucionais soltas. O JSON permanece texto puro, `questionSetRevision: 1`, **42 IDs únicos**, 40 origens `authorial`, 2 `previous_exam`, cinco alternativas por questão e todos os gabaritos apontando para alternativas existentes.

**PC-E14 permanece em andamento:** U123–U137 estão C/H/Q `done`; U138–U141 seguem `pending`. A próxima intervenção habilitada é U138 — Crimes eleitorais — Lei nº 4.737/1965.
