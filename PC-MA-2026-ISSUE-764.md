...
Estado editorial após o aceite confirmado de U117; PC-E12 permanece concluído e PC-E13 segue em execução; a migração documental anterior permanece apenas como origem deste registro.

| Dimensão | Total | pending | analyzing | done |
|---|---:|---:|---:|---:|
| Unidades reais previstas | 158 | 41 | 0 | 117 |
| Entregáveis de unidade C/H/Q | 474 | 123 | 0 | 351 |
...
Recontagem dos aceites registrados, sem somar macros ou visões: `U001–U074`, `U076–U117` e `U144` = **117 unidades**. Pendentes: `U075`, `U118–U143`, `U145–U158` = **41 unidades**. Cada conjunto possui o mesmo estado em C/H/Q nesta consolidação; isso não obriga igualdade de estados em ciclos futuros.

Visões consumidoras registradas: **119 = 102 físicas locais + 17 vínculos canônicos**. U117 acrescentou uma visão física local; o `grupo.json` de Direito Constitucional permanece estrutural e não é visão nem unidade. Não confundir 119 visões materializadas com 117 unidades aceitas. O total de unidades canônicas únicas não deve ser deduzido automaticamente da quantidade de vínculos sem resolver suas origens.
...
**Próxima ação editorial: U118 — Poder Legislativo — estrutura, funcionamento e atribuições**, C/H/Q `pending`. U117 foi concluída; PC-E13-C/H/Q permanece `pending` como macro enquanto U118–U122 não forem concluídas.
...
**Ordem habilitada:** U118 é a primeira unidade pendente de PC-E13. U112–U117 estão publicadas; seguir U118–U122, salvo dependência material comprovada ou pedido explícito.
...
Pacote de Poder Executivo — atribuições e responsabilidades do Presidente da República: C/H/Q `done`, nova/local, consumidor PC-MA, `storageId: pc-u117`, `order: 117`. Snapshot editorial final `46bf56a9b877bb68483ea41d6b180b55a04fc9cf`; base de publicação `c0b98f64df313f91d78eb9586cd595e0bb9eeda6`. A comparação base→snapshot confirma **exatamente quatro arquivos da U117**, sem alterações laterais: `conteudo.md`, `cheat-sheet.md`, `referencias.md` e `questoes.json`.

A unidade permanece **nova/local**, sem `vinculo.json`. O apoio físico principal do TCE-MA, `conhecimentos-gerais/direito-constitucional/poder-executivo-presidente-republica/` (árvore `935af0aaeb5a68875f60dcdce6525be90573c975`), foi auditado integralmente e reaproveitado seletivamente. O pacote complementar de Noções sobre Presidente e Ministros foi usado somente para conferir fronteiras de atribuição e delegação. O detalhamento dos arts. 87 e 88 foi cortado do núcleo; organização administrativa detalhada permanece em U099.

Foram publicadas **22 questões — 21 autorais + 1 adaptação não literal verificada**. A anterior deriva da questão 27 da prova Cebraspe TCE-MS 2025, conhecimentos gerais para os cargos 2 e 4, com gabarito oficial definitivo D. A adaptação preserva o núcleo sobre art. 86, § 4º, e contrasta delegação, decreto e suspensão sem reproduzir o enunciado original.

Recorte coberto: titularidade do Poder Executivo; eleição e posse apenas como contexto; impedimento, vaga, substituição, sucessão e dupla vacância; mandato e ausência do País; competências presidenciais do art. 84 organizadas por função; decreto regulamentar versus decreto do inciso VI; relações exteriores, defesa, Congresso, contas, indulto, nomeações e delegação; crimes de responsabilidade do art. 85; filtro de dois terços da Câmara; bifurcação entre infração penal comum no Supremo Tribunal Federal e crime de responsabilidade no Senado; eventos de suspensão, limite de 180 dias, prisão, atos estranhos às funções e julgamento do art. 52.

Fontes revalidadas: Constituição Federal compilada, especialmente arts. 52 e 76–86; Lei nº 1.079/1950, especialmente arts. 2º, 14 e 15; repertório oficial do Supremo Tribunal Federal sobre o art. 86; Emenda Constitucional nº 139/2026 para controle do corte; prova e gabarito definitivo Cebraspe TCE-MS 2025. O texto explicita que a proteção do art. 86, § 4º, é temporária e estritamente penal segundo a jurisprudência registrada, e que a referência histórica de até cinco anos da Lei nº 1.079/1950 não substitui a inabilitação constitucional de oito anos do art. 52. O corte legislativo permanece em **13/7/2026**; a regra jurisprudencial do edital continua separada e sujeita à revalidação final da campanha.

Microglossário: conteúdo e revisão rápida foram auditados para siglas/abreviações institucionais renderizadas; as marcações `abbr` estão balanceadas. A inspeção final deixou nomes por extenso nas referências e não encontrou siglas institucionais residuais fora de código, identificadores ou algarismos romanos. Termos como impedimento, vaga, sanção, veto, indulto, denúncia e queixa-crime são explicados no corpo. O JSON permanece em texto puro.

Próxima unidade habilitada: U118 — Poder Legislativo — estrutura, funcionamento e atribuições.
