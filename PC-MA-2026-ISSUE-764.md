...
Estado editorial após o aceite confirmado de U119; PC-E12 permanece concluído e PC-E13 segue em execução; a migração documental anterior permanece apenas como origem deste registro.

| Dimensão | Total | pending | analyzing | done |
|---|---:|---:|---:|---:|
| Unidades reais previstas | 158 | 39 | 0 | 119 |
| Entregáveis de unidade C/H/Q | 474 | 117 | 0 | 357 |
...
Recontagem dos aceites registrados, sem somar macros ou visões: `U001–U074`, `U076–U119` e `U144` = **119 unidades**. Pendentes: `U075`, `U120–U143`, `U145–U158` = **39 unidades**. Cada conjunto possui o mesmo estado em C/H/Q nesta consolidação; isso não obriga igualdade de estados em ciclos futuros.

Visões consumidoras registradas: **121 = 104 físicas locais + 17 vínculos canônicos**. U119 acrescentou uma visão física local; o `grupo.json` de Direito Constitucional permanece estrutural e não é visão nem unidade. Não confundir 121 visões materializadas com 119 unidades aceitas. O total de unidades canônicas únicas não deve ser deduzido automaticamente da quantidade de vínculos sem resolver suas origens.
...
**Próxima ação editorial: U120 — Funções essenciais à Justiça — Advocacia, Ministério Público, Advocacia Pública e Defensoria Pública**, C/H/Q `pending`. U119 foi concluída; PC-E13-C/H/Q permanece `pending` como macro enquanto U120–U122 não forem concluídas.
...
**Ordem habilitada:** U120 é a primeira unidade pendente de PC-E13. U112–U119 estão publicadas; seguir U120–U122, salvo dependência material comprovada ou pedido explícito.
...
Pacote de Poder Judiciário — disposições gerais: C/H/Q `done`, nova/local, consumidor PC-MA, `storageId: pc-u119`, `order: 119`. Snapshot editorial final `401c841cbfdc2e14a4ad5c31a0ec38e4f7e93fda`; base de publicação `68c51048f2c1ca004698dfa188e5c140ff479970`. A comparação base→snapshot confirma **exatamente quatro arquivos da U119**, sem alterações laterais: `conteudo.md`, `cheat-sheet.md`, `referencias.md` e `questoes.json`.

A unidade permanece **nova/local**, sem `vinculo.json`. O apoio físico do TCE-MA `conhecimentos-gerais/direito-constitucional/poder-judiciario/` (árvore `7610d95da2f769f40db18019a6b08df97491df8d`) foi auditado integralmente. Como o doador detalha também Supremo Tribunal Federal, Superior Tribunal de Justiça, Justiça Federal, Justiças especializadas, Justiça dos Estados e Conselho Nacional de Justiça, o reaproveitamento foi seletivo: U119 ficou restrita à Seção I do capítulo constitucional, arts. 92–100. O Conselho Nacional de Justiça aparece apenas quando esses dispositivos o exigem; composição e competências do art. 103-B foram excluídas.

Foram publicadas **24 questões autorais e nenhuma questão anterior**. O doador possui apenas autorais no recorte das disposições gerais; candidatos externos localizados durante a auditoria foram descartados quando anulados ou dependentes de jurisprudência/competências específicas além do item 9.1. Não foi criada quota artificial de questões anteriores.

Recorte coberto: órgãos do Poder Judiciário, distinção entre sede e jurisdição nacional; ingresso, promoção, formação, subsídio, remoção, publicidade, continuidade e órgão especial da magistratura; quinto constitucional; vitaliciedade, inamovibilidade, irredutibilidade e vedações; competências organizatórias dos tribunais; regra especial da EC 134/2024 para Tribunais de Justiça com mais de 170 desembargadores; reserva de plenário; juizados especiais e justiça de paz; autonomia administrativa/financeira e orçamento; regime de precatórios, incluindo ordem cronológica, alimentos, superpreferência, obrigação de pequeno valor, prazo de 1º de fevereiro, sequestro, cessão, precatório de grande valor e os limites subnacionais introduzidos pela EC 136/2025.

Fontes revalidadas: Constituição Federal compilada, especialmente arts. 92–100; Emenda Constitucional nº 130/2023; Emenda Constitucional nº 134/2024; Emenda Constitucional nº 136/2025; art. 3º da Emenda Constitucional nº 113/2021 na redação de 2025; e Emenda Constitucional nº 139/2026 como controle temporal sem alteração dos arts. 92–100. O corte legislativo permanece em **13/7/2026**.

Densidade: o conteúdo visível local ficou em aproximadamente **20,8 mil caracteres**, contra **26,8 mil** do doador, redução de cerca de 22% apesar da atualização integral do núcleo de precatórios. Microglossário: siglas institucionais e técnicas renderizadas foram marcadas em cada ocorrência pertinente ou escritas por extenso; `abbr` está balanceado; a inspeção residual encontrou apenas algarismos romanos e identificadores administrativos fora da aula. O JSON permanece em texto puro. Não foram criadas resoluções separadas, pois as explicações do conjunto são suficientes.

Próxima unidade habilitada: U120 — Funções essenciais à Justiça — Advocacia, Ministério Público, Advocacia Pública e Defensoria Pública.
