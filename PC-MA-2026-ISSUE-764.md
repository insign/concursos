...
Estado editorial após o aceite confirmado de U151; PC-E16 — Medicina Legal permanece `pending` com U149–U151 `done` e U152–U155 `pending`; a migração documental anterior permanece apenas como origem deste registro.

| Dimensão | Total | pending | analyzing | done |
|---|---:|---:|---:|---:|
| Unidades reais previstas | 158 | 8 | 0 | 150 |
| Entregáveis de unidade C/H/Q | 474 | 24 | 0 | 450 |
...
Recontagem dos aceites registrados, sem somar macros ou visões: `U001–U074` e `U076–U151` = **150 unidades**. Pendentes: `U075`, `U152–U158` = **8 unidades**. Cada conjunto possui o mesmo estado em C/H/Q nesta consolidação; isso não obriga igualdade de estados em ciclos futuros.

Visões consumidoras registradas: **151 = 134 físicas locais + 17 vínculos canônicos**. U151 acrescentou uma nova visão física local. Não confundir 151 visões materializadas com 150 unidades aceitas. O total de unidades canônicas únicas não deve ser deduzido automaticamente da quantidade de vínculos sem resolver suas origens.

Reservas ativas após o aceite de U151: **nenhuma**. PC-R04 permanece `pending`, com **41/42** parciais aceitas; somente U075 permanece divergente/pendente nessa frente.

**Próxima ação editorial: U152 — Traumatologia médico-legal — lesões por ação contundente, armas brancas e projéteis**, C/H/Q `pending`. U149–U151 estão `done`; U152–U155 permanecem `pending`.
...
| U149–U151 | Medicina Legal; novas | C/H/Q done; U151 snapshot final `98e9cb4ba7f113dd3fab1498d31eb183ea1b7bf1`; ver matriz de PC-E16 abaixo |
| U152–U155 | Medicina Legal; novas | C/H/Q pending; planejamento individual materializado em 21/09/2026 sob `PC-E16-PLANEJAMENTO-20260921T0532-01`; ver matriz de PC-E16 abaixo |
...
**Próxima unidade habilitada:** U152 — Traumatologia médico-legal — lesões por ação contundente, armas brancas e projéteis, C/H/Q `pending`. U149–U151 estão publicados e aceitos.
...
Pacote de **Documentos médico-legais e identificação — identidade, reconhecimento e métodos**: C/H/Q `done`, **nova/local**, consumidor PC-MA, `storageId: pc-u151`, `order: 151`. Snapshot editorial final `98e9cb4ba7f113dd3fab1498d31eb183ea1b7bf1`; base reservada `3b51d7a0652fdf04b0aee0546388e2dfea506138`. A comparação base→snapshot confirma **exatamente quatro arquivos novos da U151**; o primeiro commit `830f5bb23f5594959a8676acb588cbd3a800c69c` publicou o pacote e o segundo apenas concluiu o microglossário de `referencias.md`.

A unidade permanece sem `vinculo.json` e sem doador integral compatível. U134 foi preservada como fronteira do regime jurídico da identificação criminal e dos bancos biométricos; U093, como fronteira do reconhecimento processual do artigo 226 do CPP; U110, apenas como contexto institucional de identificação/papiloscopia. O arquivo anexado de Administração do TCE/MA foi auditado e descartado como doador por ausência de aderência.

Cobertura publicada: documento médico e função médico-legal; nomenclatura profissional vigente × taxonomia clássica de concurso; atestado; relatório médico circunstanciado e especializado; parecer técnico; laudo médico-pericial e laudo médico; relatório médico-legal/laudo/auto na classificação tradicional; sete blocos didáticos do laudo; prontuário como fonte e não conclusão; identidade × identificação × reconhecimento; cinco requisitos clássicos de identificação; papiloscopia, dactiloscopia, quiroscopia, podoscopia e necropapiloscopia; identificação odontológica; identificação genética; Antropologia Forense e perfil biológico; identificadores primários × informações secundárias; comparação de dados anteriores e posteriores à morte; escolha e combinação de métodos. O rito de U093 e as hipóteses legais de U134 não foram duplicados.

Foram publicadas **28 questões: 24 autorais + 4 anteriores verificadas**. As anteriores são adaptações não literais das questões 25, 27, 31 e 32 do Cebraspe/PC-RO 2022 — Médico-Legista, com gabaritos definitivos B, C, C e E, respectivamente. Elas cobrem relatório médico-legal, arcada dentária como método primário, parecer e o conjunto perenidade/unicidade/praticabilidade/imutabilidade/classificabilidade. Nenhuma resolução separada foi necessária.

Densidade final: `conteudo.md` **24.530 caracteres**, `cheat-sheet.md` **5.671**, `referencias.md` **7.130** e `questoes.json` **27.472**. Microglossário: **24/9/11 pares `abbr`** em conteúdo/revisão/referências, todos balanceados; a inspeção final não deixou siglas institucionais/técnicas nuas nos materiais Markdown auditados. `questionSetRevision: 1`, **28 IDs únicos**, cinco alternativas por questão, gabaritos existentes e explicações não vazias.

Fontes revalidadas em 21/9/2026: Edital PC-MA; Resoluções CFM nº 2.381/2024, nº 2.418/2024 e nº 2.430/2025; material institucional da Advocacia-Geral da União; Escola Superior da Polícia Civil de Goiás; INTERPOL; Polícia Científica de Santa Catarina; prova e gabarito definitivo Cebraspe PC-RO 2022. O corte legislativo de 13/7/2026 foi preservado.

**PC-E16 permanece em andamento:** U149–U151 estão C/H/Q `done`; U152–U155 seguem `pending`. Próxima unidade: U152 — Traumatologia médico-legal — lesões por ação contundente, armas brancas e projéteis.
