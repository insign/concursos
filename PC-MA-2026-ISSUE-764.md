...
Estado editorial após o aceite confirmado de U153; PC-E16 — Medicina Legal permanece `pending` com U149–U153 `done` e U154–U155 `pending`; a migração documental anterior permanece apenas como origem deste registro.

| Dimensão | Total | pending | analyzing | done |
|---|---:|---:|---:|---:|
| Unidades reais previstas | 158 | 6 | 0 | 152 |
| Entregáveis de unidade C/H/Q | 474 | 18 | 0 | 456 |
...
Recontagem dos aceites registrados, sem somar macros ou visões: `U001–U074` e `U076–U153` = **152 unidades**. Pendentes: `U075`, `U154–U158` = **6 unidades**. Cada conjunto possui o mesmo estado em C/H/Q nesta consolidação; isso não obriga igualdade de estados em ciclos futuros.

Visões consumidoras registradas: **153 = 136 físicas locais + 17 vínculos canônicos**. U153 acrescentou uma nova visão física local. Não confundir 153 visões materializadas com 152 unidades aceitas. O total de unidades canônicas únicas não deve ser deduzido automaticamente da quantidade de vínculos sem resolver suas origens.

Reservas ativas após o aceite de U153: **nenhuma**. PC-R04 permanece `pending`, com **41/42** parciais aceitas; somente U075 permanece divergente/pendente nessa frente.

**Próxima ação editorial: U154 — Exame médico-legal de locais de crime**, C/H/Q `pending`. U149–U153 estão `done`; U154–U155 permanecem `pending`.
...
| U149–U153 | Medicina Legal; novas | C/H/Q done; U153 snapshot final `3fd6efac49a21362486b004f50195fc2e124734d`; ver matriz de PC-E16 abaixo |
| U154–U155 | Medicina Legal; novas | C/H/Q pending; planejamento individual materializado em 21/09/2026 sob `PC-E16-PLANEJAMENTO-20260921T0532-01`; ver matriz de PC-E16 abaixo |
...
**Próxima unidade habilitada:** U154 — Exame médico-legal de locais de crime, C/H/Q `pending`. U149–U153 estão publicados e aceitos.
...
Pacote de **Tanatologia forense — morte, fenômenos cadavéricos e cronologia médico-legal**: C/H/Q `done`, **nova/local**, consumidor PC-MA, `storageId: pc-u153`, `order: 153`. Snapshot editorial final `3fd6efac49a21362486b004f50195fc2e124734d`; base reservada `c9e8565faaecc713f764506af374ed899082bf37`. A comparação base→snapshot confirma **exatamente quatro arquivos novos da U153**, sem alteração lateral.

A unidade permanece sem `vinculo.json` e sem doador integral compatível. U149–U152 foram usadas como base conceitual/metodológica, sem cópia automática; U110 apenas confirma institucionalmente Tanatologia Forense no Instituto Médico Legal do Maranhão. U154 permanece dona do exame médico-legal do local, e U155 da Psiquiatria Forense. Os anexos disponíveis eram materiais do Tribunal de Contas do Estado do Maranhão e não foram reaproveitados.

Cobertura publicada: conceito e diagnóstico da morte; fenômenos abióticos imediatos; morte encefálica com pré-requisitos, dois exames clínicos, teste de apneia e exame complementar; algor, livor, rigor, espasmo cadavérico e desidratação; autólise, putrefação e sua progressão clássica; maceração fetal; mumificação e adipocera; cronotanatognose como estimativa do intervalo pós-morte por integração de sinais, com limites de temperatura, livor, rigor, humor vítreo, entomologia e conteúdo gastrointestinal; comoriência do art. 8º do Código Civil e preservação da divergência terminológica “primoriência” do edital × “premoriência” em outras fontes; exumação e art. 163 do CPP; causa médica × mecanismo fisiopatológico × causa/maneira médico-legal; Declaração de Óbito; morte súbita × morte suspeita; SVO × IML. U154 não foi antecipada além das pontes indispensáveis.

Foram publicadas **31 questões: 26 autorais + 5 anteriores verificadas**. As anteriores são adaptações não literais das questões 2, 6 e 13 da prova oral Cebraspe/PC-RO 2022 — morte encefálica, fenômenos cadavéricos e cronotanatognose/comoriência — e das questões objetivas 43 e 41, gabaritos definitivos B e C, sobre sequência clássica da rigidez e maceração asséptica. Nenhuma resolução separada foi necessária.

Densidade final: `conteudo.md` **26.393 caracteres**, `cheat-sheet.md` **5.060**, `referencias.md` **8.810** e `questoes.json` **29.536**. Microglossário: **19/9/8 pares `abbr`** em conteúdo/revisão/referências, todos balanceados; os tokens em caixa alta remanescentes em referências são iniciais bibliográficas de autores. `questionSetRevision: 1`, **31 IDs únicos**, cinco alternativas por questão, gabaritos existentes e explicações não vazias.

Fontes revalidadas em 21/9/2026: Edital PC-MA; Resolução CFM nº 2.173/2017, reafirmada por Parecer CFM nº 20/2026; Lei nº 9.434/1997; Código Civil; CPP; Ministério da Saúde; revisões científicas de 2016–2026 sobre intervalo pós-morte, livores, humor vítreo, adipocera e morte súbita; manual oficial do Instituto Médico-Legal de Goiás; prova objetiva, gabarito definitivo e padrão oral Cebraspe/PC-RO 2022. O corte legislativo de 13/7/2026 foi preservado.

**PC-E16 permanece em andamento:** U149–U153 estão C/H/Q `done`; U154–U155 seguem `pending`. Próxima unidade: U154 — Exame médico-legal de locais de crime.
