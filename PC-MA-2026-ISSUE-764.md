...
Estado editorial após o aceite confirmado de U146; PC-E14 — Legislação Especial está concluído e PC-E15 — Direitos Humanos permanece `pending`; a migração documental anterior permanece apenas como origem deste registro.

| Dimensão | Total | pending | analyzing | done |
|---|---:|---:|---:|---:|
| Unidades reais previstas | 158 | 13 | 0 | 145 |
| Entregáveis de unidade C/H/Q | 474 | 39 | 0 | 435 |
...
Recontagem dos aceites registrados, sem somar macros ou visões: `U001–U074` e `U076–U146` = **145 unidades**. Pendentes: `U075`, `U147–U158` = **13 unidades**. Cada conjunto possui o mesmo estado em C/H/Q nesta consolidação; isso não obriga igualdade de estados em ciclos futuros.

Visões consumidoras registradas: **146 = 129 físicas locais + 17 vínculos canônicos**. U146 acrescentou uma nova visão física local. Não confundir 146 visões materializadas com 145 unidades aceitas. O total de unidades canônicas únicas não deve ser deduzido automaticamente da quantidade de vínculos sem resolver suas origens.

Reservas ativas após o aceite de U146: **nenhuma**. PC-R04 permanece `pending`, com **41/42** parciais aceitas; somente U075 permanece divergente/pendente nessa frente.

**Próxima ação editorial: U147 — Controle de convencionalidade e direitos humanos na Constituição Federal de 1988**, C/H/Q `pending`, conforme o planejamento individual de PC-E15. U142–U146 estão `done`; U147–U148 seguem `pending`.
...
| U147–U148 | Direitos Humanos; novas | C/H/Q pending; planejamento individual materializado em 20/09/2026 sob `PC-E15-PLANEJAMENTO-20260920-01`; ver matriz de PC-E15 abaixo |
...
**Ordem habilitada após o aceite de U146:** U147 → U148. A sequência preserva pré-requisitos: sistema interamericano antes do controle de convencionalidade e fundamentos antes da aplicação policial.
...
**Próxima unidade habilitada:** U147, C/H/Q `pending`. PC-E15-C/H/Q permanece `pending` até U147–U148 serem concluídas; U142–U146 estão `done`.
...
Pacote de **Sistema Interamericano de Direitos Humanos — OEA, Convenção Americana, Comissão e Corte**: C/H/Q `done`, **nova/local**, consumidor PC-MA, `storageId: pc-u146`, `order: 146`. Snapshot editorial final `2e9169e20c1f149679192572fe5c6f7e00bf712e`; base reservada `5c5b194ad87529382fdeed8fb005d16295bdc887`. A inspeção dos commits entre a base e o snapshot confirma alterações restritas aos **quatro arquivos da U146**: `conteudo.md`, `cheat-sheet.md`, `referencias.md` e `questoes.json`, sem arquivo lateral.

A unidade permanece **nova/local**, sem `vinculo.json` e sem doador integral compatível. O canônico `nocoes-direitos-humanos/teoria-geral-direitos-fundamentais/` foi auditado como apoio de fronteira, não como origem: seu uso da Convenção concentra-se em hierarquia brasileira e depositário infiel. U143 permanece responsável por incorporação, ratificação/promulgação e hierarquia; U145 permanece no sistema global dos Pactos; U147 recebe controle de convencionalidade. Nenhuma dessas origens/unidades foi alterada.

Cobertura publicada: moldura da OEA e artigo 106 da Carta; natureza e estrutura da Convenção Americana; deveres dos artigos 1º–2º; mapa dos direitos dos artigos 3º–26; suspensão e núcleo não suspensível do artigo 27; interpretação/restrições; emendas e protocolos dos artigos 76–77; composição, funções e petições da Comissão; comunicação interestatal; admissibilidade e exceções; solução amistosa e relatórios; medidas cautelares; composição e competências contenciosa/consultiva da Corte; submissão de casos, reparações, medidas provisórias, sentença e cumprimento; e cronologia brasileira de 1992/1998. O fluxo central foi fixado como pessoa/grupo/entidade → Comissão → eventual Corte, sem antecipar a teoria de controle de convencionalidade de U147.

Foram publicadas **25 questões: 24 autorais + 1 anterior verificada**, sem quota artificial. A anterior é adaptação não literal da questão 55 do Cebraspe/PC-ES 2022, Delegado, gabarito definitivo D, sobre mecanismos de emenda e protocolos adicionais da Convenção Americana. Nenhuma resolução separada foi necessária.

Densidade final: `conteudo.md` com **26.992 caracteres**, `cheat-sheet.md` com **5.148**, `referencias.md` com **6.248** e `questoes.json` com **27.390**. Microglossário final: **29 pares `abbr` no conteúdo, 8 no cheat sheet e 2 nas referências**, todos balanceados, sem títulos vazios; o JSON permanece texto puro. `questionSetRevision: 1`, **25 IDs únicos**, cinco alternativas por questão, gabaritos apontando para opções existentes e explicações não vazias.

Corte e fontes: Carta da OEA, texto oficial da Convenção Americana, estado oficial de ratificações, Decreto nº 678/1992, Decreto nº 4.463/2002, páginas institucionais e Regulamento da Comissão foram revalidados em 21/9/2026. A consulta posterior ao edital foi usada para conferência documental; não foi importada alteração normativa posterior ao corte legislativo de 13/7/2026.

**PC-E15 permanece em andamento:** U142–U146 estão C/H/Q `done`; U147–U148 seguem `pending`. A próxima unidade habilitada é U147 — Controle de convencionalidade e direitos humanos na Constituição Federal de 1988.
