...
Estado após as inspeções contextuais de **U001–U005, U007, U008, U010–U027 em PC-F02**, com U027 concluída em 24/09/2026: U001–U158 permanecem C/H/Q `done`. PC-F01 continua concluída; esses vinte e cinco pacotes locais foram inspecionados contextualmente e a correção de referências de U035 está documentada na seção 4, mas **não constituem aceite editorial global de PC-F02**. O restante de PC-F02 e PC-F03–PC-F05 permanece `pending`; PC-P02–PC-P05 continuam sem linhas próprias recuperáveis e não têm estado inferido.
...
**Próxima ação habilitada: PC-F02 — seguir para U028 — Segurança da informação: confidencialidade, integridade e disponibilidade.** U006 continua pulada pela divergência de identidade já registrada. A identidade de U009 foi conferida na `main` como `pc-u009`, ordem 9, em `estrutura-morfossintatica-periodo`, mas a própria unidade apresenta **divergência de classificação**: PC-R02 herdado a inclui entre as parciais, enquanto `referencias.md` afirma que nenhum doador equivalente foi localizado e a trata como assunto novo/local. U009 deve ser pulada, sem normalização por inferência, até reconciliação autorizada. U008 e U010–U027 já foram inspecionadas e permanecem C/H/Q `done`. Não repetir publicações confirmadas nem converter contagens, presença de arquivos ou buscas sem resultado em prova de conformidade pedagógica integral. PC-F01 está `done` com auditoria registrada abaixo.
...
**U022 — inspeção contextual concluída sem alteração:** itens 20.2.2, Informática 1 e 5; pacote físico novo/local `internet-intranet-navegacao-redes-sociais`, `pc-u022`, ordem 22, consumidor PC-MA, sem `vinculo.json`. C, H, R e 20 questões foram lidos. As fronteiras U023 (sistemas operacionais), U025 (e-mail), U026 (redes/endereçamento) e U028–U032 (segurança) delimitam o recorte. A aula distingue infraestrutura global, Web, intranet, navegador, mecanismo de busca, URL, navegação local, impressão e redes sociais; H recupera os conceitos sem ampliar o escopo. Referências NIST, RFC 3986/9110, MDN, Mozilla, Google, Microsoft e CERT.br foram confrontadas com as afirmações pertinentes; o canônico `redes-tcp-ip-interoperabilidade` foi usado somente para fronteira e não foi alterado. Q mantém 20 IDs, 17 autorais + 3 adaptações, cinco alternativas, gabaritos e `questionSetRevision: 1`. Caderno/gabarito definitivo Telebras/CESPE 2015, itens 102 C, 106 C e 108 E, reconferidos em 24/09/2026. A antiga observação de possível atribuição à PCDF não é sustentada pelo Q/R locais: as três adaptações correspondem às provas da Telebras, sem necessidade de alterar a proveniência local. Nenhuma resolução separada necessária. Blobs sem mudança: C `318358e2fd8ff603c4b81c123ab33991cca1edab`, H `4fe0f52cdf32f6c9f5e45de8343327c9dbd265b1`, R `4af751fbb8922a85d0672425201072f378857872`, Q `2a0263eddfcfed3da7598c9e8827827bfa653303`; crescimento de texto visível, marcação e microdescrições zero.

**U023 — inspeção contextual concluída com correção pontual:** item 20.2.2, Informática 2; pacote físico parcial/local `sistemas-operacionais-windows-linux`, `pc-u023`, ordem 23, consumidor PC-MA. O canônico doador `competencias-digitais-informatica-aplicada-setor-publico/windows-arquivos-pastas` (C `d31f9842ddcbea17f66b661d224e2bfa4ac60b59`, H atual `c6829185f1ffa479bc03f5c885e78cf50bf0978e`, R atual `53a0bafa75c77ba80224fe6a56e31e684d86005b`, Q `e2d717e0c76d0c03015a1c9add420b412e4413f0`) alimentou conceitos e operações de Windows; H/R do doador têm SHA atual diferente dos blobs históricos citados na proveniência local, sem invalidar o registro da base auditada. Vínculos TCE Analista e Técnico resolvidos, ambos SHA `27e53aa50f6dcc7404a869a9525850a280472677`; origem compartilhada preservada. C/H/R/Q locais e fronteira U024 lidos; Linux foi completado localmente, sem herdar permissões NTFS/EFS, instalação ou indexação do canônico. Fontes Microsoft, FHS, GNU, GNOME, Ubuntu e freedesktop examinadas conforme as afirmações. Q tem 20 IDs, 17 autorais + 3 adaptações, cinco opções, conjunto revisão 1. Cadernos/gabaritos definitivos da FUB/Cebraspe 2025 reconfirmam CB2 item 31 E e CB4 itens 23 E e 24 E. A questão `u023-a02` renderizava barras invertidas duplicadas por escape JSON excessivo; o prompt e a explicação foram corrigidos em `83747fa3031b52193fb8e1926716316e780cb96e`, revisão individual 1 → 2, gabarito C e `questionSetRevision: 1` preservados. Sem resolução separada necessária. Blobs locais finais C `9e7dad2b980554289dae5b5e2e81424904f91694`, H `900982e7b3782c46a965c4664b4b73840d7d8417`, R `bfe65cf9ddfe1dc54df91d9308410ebf3513cd60`, Q `dd11f9fff00675c1ba3ad20600634ed9e0a29f8c`.

**U024 — inspeção contextual concluída com ajustes de R/Q:** item 20.2.2, Informática 3; pacote físico parcial/local `editores-textos-planilhas-apresentacoes`, `pc-u024`, ordem 24, consumidor PC-MA. C/H/R/Q locais (24 questões) confrontados com três doadores canônicos Word, Excel e PowerPoint, suas questões/referências, vínculos TCE Analista/Técnico (respectivamente SHAs `9da8c8f7e539ec3943b5f956a8500688ddcfcdf4`, `22d3ae676a8431b91d7cffba0ec623f8400800d6`, `901aa43c613ea4efbe6a00c5c1af9ebae9fc1c9a`) e fronteiras U023/U025; biblioteca e consumidores preservados. A classificação parcial se justifica pela fusão das três origens Microsoft e complemento local LibreOffice/Apache OpenOffice. Os C dos doadores têm os mesmos SHAs históricos em R local; H atual Word/Excel/PowerPoint `8f9307116291ac235bbd0960729e19eed17a2df8`/`de283d796c4107653d9c91f23e16701b95cebac3`/`aedd86440a757f96a24c69e07bc753e2589eed26`, R atual Excel/PowerPoint `fafdfb84f2c61c3648d3639a4732ed58bd931243`/`903f30050d758df6ac9fb8f09e322b6f74e70c87` e Q atual Excel `8924e64be281708cff7403e42aa1f2d2280cac91` mudaram após os blobs históricos de proveniência; estes permanecem como retrato da base auditada. C/H ensinam/revisam famílias de aplicativos, formatos, estilos, referências, slides e interoperabilidade sem assimilar recursos avançados fora do recorte. Documentação Microsoft, The Document Foundation e Apache OpenOffice confrontada; R recebeu links oficiais de PowerPoint e Impress para `Ctrl+M` em `5344c294b5235fa54ca9cd55c8bbdd4dd029592a`. Caderno/gabarito definitivo da FGV ALE-RO 2026 q22 C, PC-RJ 2022 Tipo 2 q98 C e MACAEPREV 2024 Tipo 1 q26 B reconferidos; Q mantém 21 autorais + 3 adaptações, cinco opções, gabaritos e `questionSetRevision: 1`. `u024-p01`/`p02`/`p03` agora perguntam diretamente, sem introdução metatextual; revisões individuais 1 → 2 em `b9f2a71f6061cc85443237c899b202ce142040d4`. Nenhuma resolução separada necessária. Blobs finais C `3cd76191b1df156d5b7357a2ab3916eef4fcfea9`, H `ac9768f8ff950fdf245a1a43c17997098d3f2fdf`, R `b14681c1e6c3279aec4cc8ec22808651ae3b44e6`, Q `9d3337efafe5f7c8a317183712b2cb11402feb9d`.

**U025 — inspeção contextual concluída com correção de proveniência:** item 20.2.2, Informática 4; pacote físico novo/local `correio-eletronico-smtp-imap`, `pc-u025`, ordem 25, consumidor PC-MA, sem vínculo. C/H/R/Q locais (20 questões) lidos com fronteiras U022/U024/U026/U028–U032; canônicos `comunicacao-colaboracao-remota` e `redes-tcp-ip-interoperabilidade` examinados no recorte SMTP/IMAP, somente leitura, sem equivalência integral inferida. Documentação RFC 5321, 5322, 6409, 9051, 2045 e registro IANA usada para conferir envio, acesso, cabeçalhos, anexos e portas convencionais. C/H preservados. Cadernos/gabaritos FGV Câmara Recife 2014 q50 A, ALEMA Analista de Suporte de Rede 2023 Tipo 1 q50 E e PM-SP 2024 Tipo 1 q54 C reconferidos. Cebraspe MP-TO 2024 item 109 E também reconferido: o enunciado original inverte SMTP e **POP**, enquanto a adaptação local discute SMTP e **IMAP**. R explicitou essa substituição e adicionou o gabarito em `609288036d00535223e87e20cbfcbd3e200507b6` e precisou a expansão de POP em `68dac39e9b3f28241fbdc2a4d5fb26bd68af3a7a`. Q reformulou diretamente os quatro prompts anteriores, revisão individual 1 → 2, e especificou a troca temática em `u025-p04`, commit `7f248de6c54cb0f95cfe6ab6d3a9c1a750aca501`. Preservados 16 IDs autorais + 4 adaptados, cinco opções, gabaritos e `questionSetRevision: 1`; sem resolução separada necessária. Blobs finais C `d347cc042833ace0ad886288ea96d665004e6ce7`, H `d931fc35d95d69e1fa83ab6453a437e3b2db8a14`, R `7f6d96a1afcab7f35a1c7b9a0b2ea41801629581`, Q `9d3933c449952e738131cbac4082418ada612ccd`.

**U027 — inspeção contextual concluída com ajustes de R/Q:** item 20.2.2, Informática 7; pacote físico parcial/local `computacao-nuvem-armazenamento-colaboracao`, `pc-u027`, ordem 27, consumidor PC-MA. C/H/R/Q locais (18 questões) confrontados com os doadores canônicos `backup-armazenamento-nuvem` (C `d8e0944b6f1989a3e42995d31605255c8d375867`, Q `b52a149cb04eb162622486482aa84cc693a2e216`) e `comunicacao-colaboracao-remota` (C `393831b03609dda5fc25e343bb6a5b0573db1f1d`), mais vínculos dos TCE Analista/Técnico, SHA `7a94c87831a645dfd26ed7aaddef3e3f47766404`/`798c91477452e618cb1a8bda45dbb4877d50b482`. H/R/Q atuais dos canônicos podem diferir dos blobs históricos de proveniência em R local; a cópia parcial PC-MA permanece independente, biblioteca e consumidores preservados. Fronteiras U025/U026/U028–U032 e backup especializado do doador evitam ampliação indevida. C/H ensinam características NIST, modelos SaaS/PaaS/IaaS, armazenamento, sincronização, permissão, estados locais do OneDrive, Drive compartilhado, Teams/Meet; documentação oficial NIST, Microsoft e Google conferida. R trocou uma URL antiga do OneDrive pela rota atual da Microsoft e acrescentou página do Google sobre propriedade de arquivos em drive compartilhado em `6b5014110502fe4c47c56e7e7f065128b0deb216`. Cadernos/gabaritos FGV PM-SP 2024 Tipo 1 q55 C e Cebraspe FNDE 2023 item 42 C reconferidos. O prompt de `u027-p01` reproduzia quase integralmente a estrutura e frases do caderno; as duas adaptações `p01`/`p02` foram reescritas em cenário e alternativas próprios, mantendo fenômeno e gabaritos, com revisões individuais 1 → 2 em `05f2a4694335a6b9fa5d110254c26624f13d44bd`. Q conserva 16 autorais + 2 adaptações, cinco opções e `questionSetRevision: 1`; sem resolução separada necessária. Blobs finais C `94897999db2194b2757c8634235d000311981908`, H `4e9be7e5aa2bdaee13e19cdf186ce22b5240aa30`, R `ebfca8105b38fa4c4cf42c311e4476876536c03e`, Q `e37354f7717b6a2055426dcebaae8a2e161ead47`.
...
**Restante de PC-F02:** U001–U005, U007, U008, U010–U027 somam **vinte e cinco pacotes locais** com inspeções contextuais documentadas; permanecem **116 pacotes locais e 17 origens canônicas** sem essa certificação final registrada. A referência corrigida de U035 não constitui inspeção integral do canônico. A triagem não permite aceite por lote de referências, Markdown, microglossário, atribuições, gabaritos ou suficiência das explicações. **Próximo recorte elegível: U028 — Segurança da informação: confidencialidade, integridade e disponibilidade.** Preservar as intervenções publicadas e só encerrar PC-F02 após inspecionar seu escopo completo. A reserva de U027 pode ser encerrada após a sincronização do painel; o e-mail é opcional.
...
Grupo `conhecimentos-gerais/informatica/`. As cinco unidades resumidas abaixo são novas/locais; U023/U024/U026 e outras parciais possuem doadores detalhados em linhas próprias. Todas estão C/H/Q `done`; blobs/commits na seção 8.
...
#### U022 — nova/local, inspeção contextual em PC-F02

| Edital | ID / título / recorte | Origem / SHA e classe | Slug / destino / identidade / ordem | Aproveitamento, lacunas e fronteiras | Consumidor / corte / evidência | C | H | Q |
|---|---|---|---|---|---|---|---|---|
| 20.2.2, Informática, 1/5 | U022 — **Internet, intranet, navegação, busca e redes sociais** — Internet/Web/intranet, navegador, URL, links, busca/indexação, dados locais, impressão e redes sociais | **nova/local**; origem física própria `src/content/assuntos/pc-ma-2026-oficial-investigador/conhecimentos-gerais/informatica/internet-intranet-navegacao-redes-sociais/`; C/H/R/Q blobs sem alterações na seção 8 | `internet-intranet-navegacao-redes-sociais`; `pc-u022`; ordem 22 | Programa recortado nos itens 1/5; não absorve sistemas operacionais U023, correio U025, redes U026 nem segurança U028–U032. Canônico de redes serviu apenas como fronteira. Q: 17 autorais + 3 Telebras 2015, provas/gabaritos conferidos; atribuição PCDF herdada não corresponde aos três IDs locais | PC-MA, `pcma-2026-invest`; corte 13/7/2026; inspeção 24/9/2026; sem edição material; evidência contextual seção 4 | done | done | done |

Rota preservada: `/concursos/pc-ma-2026-oficial-investigador/internet-intranet-navegacao-redes-sociais/`; quatro arquivos locais e nenhum vínculo canônico.

#### U023 — parcial/local, inspeção contextual em PC-F02

| Edital | ID / título / recorte | Origem / SHA e classe | Slug / destino / identidade / ordem | Aproveitamento, lacunas e fronteiras | Consumidor / corte / evidência | C | H | Q |
|---|---|---|---|---|---|---|---|---|
| 20.2.2, Informática, 2 | U023 — **Windows e Linux: arquivos, pastas, atalhos e área de trabalho** — caminhos, cópia/movimentação, área de transferência, referências, interface gráfica | **parcial/local**; doador `competencias-digitais-informatica-aplicada-setor-publico/windows-arquivos-pastas/`, C `d31f9842ddcbea17f66b661d224e2bfa4ac60b59`, Q `e2d717e0c76d0c03015a1c9add420b412e4413f0`; H/R históricos em R local, atuais e consumidores TCE na seção 4; C/H/R/Q locais na seção 8 | `sistemas-operacionais-windows-linux`; `pc-u023`; ordem 23 | Windows aproveitado, Linux produzido localmente; exclui NTFS/EFS, instalação, versões e indexação detalhadas do doador; U024 trata suítes de escritório. 17 questões autorais + 3 adaptações FUB 2025 com gabaritos oficiais conferidos; `u023-a02` corrigiu escape JSON | PC-MA, `pcma-2026-invest`; corte 13/7/2026; inspeção 24/9/2026; Q commit `83747fa3031b52193fb8e1926716316e780cb96e`; validade do canônico TCE preservada | done | done | done |

Rota preservada: `/concursos/pc-ma-2026-oficial-investigador/sistemas-operacionais-windows-linux/`; quatro arquivos físicos locais, sem vínculo canônico na PC-MA.

#### U024 — parcial/local, inspeção contextual em PC-F02

| Edital | ID / título / recorte | Origem / SHA e classe | Slug / destino / identidade / ordem | Aproveitamento, lacunas e fronteiras | Consumidor / corte / evidência | C | H | Q |
|---|---|---|---|---|---|---|---|---|
| 20.2.2, Informática, 3 | U024 — **Editores de textos, planilhas e apresentações** — Word/Excel/PowerPoint e Writer/Calc/Impress nas suítes LibreOffice e Apache OpenOffice | **parcial/local**; três origens canônicas `competencias-digitais-informatica-aplicada-setor-publico/microsoft-{word-documentos,excel-planilhas,powerpoint-apresentacoes}/`, C `f80b2953873a0c4dd51f1d1d6e8df986b7f79427`/`d2c838c8ea4e4b2fd885b0b3b80620ef8a7b13ee`/`41697b64bdbbd13beb228a83bc7a022b06977017`; outros blobs históricos em R local e atuais na seção 4 | `editores-textos-planilhas-apresentacoes`; `pc-u024`; ordem 24; C/H/R/Q locais na seção 8 | Microsoft condensado das três origens; LibreOffice/Apache OpenOffice complementados localmente; sem importar automações e análise avançadas. 21 autorais + 3 FGV; `Ctrl+M` documentado e prompts adaptados diretos; U023 cuida do sistema operacional, U025 do correio | PC-MA, `pcma-2026-invest`; corte 13/7/2026; inspeção 24/9/2026; commits R/Q na seção 4; TCE nos três doadores preservado | done | done | done |

Rota preservada: `/concursos/pc-ma-2026-oficial-investigador/editores-textos-planilhas-apresentacoes/`; quatro arquivos locais e nenhum vínculo canônico na PC-MA.

#### U025 — nova/local, inspeção contextual em PC-F02

| Edital | ID / título / recorte | Origem / SHA e classe | Slug / destino / identidade / ordem | Aproveitamento, lacunas e fronteiras | Consumidor / corte / evidência | C | H | Q |
|---|---|---|---|---|---|---|---|---|
| 20.2.2, Informática, 4 | U025 — **Correio eletrônico: SMTP, IMAP, mensagens e anexos** — submissão/transferência, acesso, campos, MIME, anexos e estados | **nova/local**; origem própria `src/content/assuntos/pc-ma-2026-oficial-investigador/conhecimentos-gerais/informatica/correio-eletronico-smtp-imap/`; canônicos de comunicação remota e redes serviram apenas como fronteira, sem vínculo | `correio-eletronico-smtp-imap`; `pc-u025`; ordem 25; C/H/R/Q na seção 8 | Não absorve arquitetura geral U026 nem segurança U028–U032; 16 autorais + 4 adaptações; MP-TO item 109 original SMTP/POP virou tema SMTP/IMAP, explicitado na origem e na explicação | PC-MA, `pcma-2026-invest`; corte 13/7/2026; inspeção 24/9/2026; commits R/Q seção 4 | done | done | done |

Rota preservada: `/concursos/pc-ma-2026-oficial-investigador/correio-eletronico-smtp-imap/`; quatro arquivos locais e nenhum vínculo canônico.
...
#### U027 — parcial/local, inspeção contextual em PC-F02

| Edital | ID / título / recorte | Origem / SHA e classe | Slug / destino / identidade / ordem | Aproveitamento, lacunas e fronteiras | Consumidor / corte / evidência | C | H | Q |
|---|---|---|---|---|---|---|---|---|
| 20.2.2, Informática, 7 | U027 — **Computação em nuvem, armazenamento e colaboração** — NIST, modelos de serviço, armazenamento, sincronização, permissões, OneDrive, Drive, Teams/Meet | **parcial/local**; doadores `competencias-digitais-informatica-aplicada-setor-publico/backup-armazenamento-nuvem/` e `comunicacao-colaboracao-remota/`, C `d8e0944b6f1989a3e42995d31605255c8d375867`/`393831b03609dda5fc25e343bb6a5b0573db1f1d`; demais blobs históricos em R local e atuais na seção 4 | `computacao-nuvem-armazenamento-colaboracao`; `pc-u027`; ordem 27; C/H/R/Q locais seção 8 | Integra recortes pertinentes dos dois canônicos sem migrar backup completo, e-mail ou governança detalhada de Teams; 16 autorais + 2 adaptações reescritas para não reproduzir quase literalmente os itens anteriores | PC-MA, `pcma-2026-invest`; corte 13/7/2026; inspeção 24/9/2026; commits R/Q seção 4; dois doadores TCE preservados | done | done | done |

Rota preservada: `/concursos/pc-ma-2026-oficial-investigador/computacao-nuvem-armazenamento-colaboracao/`; quatro arquivos locais e nenhum vínculo canônico na PC-MA.
...
| U022 | `22b32a62d1723303a83977de1875ad1de9d72822` — inspeção contextual PC-F02 concluída sem edição material | 17 + 3 | Telebras/CESPE 2015, itens 102 C, 106 C e 108 E, caderno/gabarito definitivo reconferidos em 24/09/2026; as três adaptações locais são Telebras, e a menção herdada à PCDF não se aplica a elas; conjunto revisão 1 |
| U023 | `83747fa3031b52193fb8e1926716316e780cb96e` — inspeção contextual PC-F02 concluída; C/H/R preservados, Q a02 corrigida | 17 + 3 | FUB/Cebraspe 2025 CB2 item 31 E, CB4 itens 23 E e 24 E; cadernos/gabaritos oficiais reconferidos 24/09/2026; a02 revisão 2, conjunto revisão 1 |
| U024 | `5344c294b5235fa54ca9cd55c8bbdd4dd029592a` + `b9f2a71f6061cc85443237c899b202ce142040d4` — inspeção contextual PC-F02 concluída; C/H preservados, R/Q ajustados | 21 + 3 | FGV ALE-RO 2026 Tipo 1 q22 C; PC-RJ 2022 Tipo 2 q98 C; MACAEPREV 2024 Tipo 1 q26 B; cadernos/gabaritos oficiais reconferidos em 24/09/2026; três adaptações revisão 2, conjunto revisão 1 |
| U025 | `609288036d00535223e87e20cbfcbd3e200507b6` + `68dac39e9b3f28241fbdc2a4d5fb26bd68af3a7a` + `7f248de6c54cb0f95cfe6ab6d3a9c1a750aca501` — inspeção contextual PC-F02 concluída; C/H preservados, R/Q ajustados | 16 + 4 | FGV Câmara Recife 2014 q50 A, ALEMA 2023 q50 E, PM-SP 2024 q54 C; Cebraspe MP-TO 2024 item 109 E original SMTP/POP; cadernos/gabaritos reconferidos 24/09/2026; quatro adaptações revisão 2, conjunto revisão 1 |
...
| U027 | `6b5014110502fe4c47c56e7e7f065128b0deb216` + `05f2a4694335a6b9fa5d110254c26624f13d44bd` — inspeção contextual PC-F02 concluída; C/H preservados, R/Q ajustados | 16 + 2 | FGV PM-SP 2024 Tipo 1 q55 C e Cebraspe FNDE 2023 item 42 C; cadernos/gabaritos oficiais reconferidos 24/09/2026; adaptações revisão 2, conjunto revisão 1 |
