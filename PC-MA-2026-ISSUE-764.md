...
**Próxima ação editorial: U123 — Lei de Drogas — tráfico ilícito e uso indevido de substâncias entorpecentes — Lei 11.343/2006**, C/H/Q `pending`, conforme o planejamento individual de PC-E14 materializado nesta consolidação. PC-E13-C/H/Q está `done`; PC-E14-C/H/Q permanece `pending` enquanto U123–U141 não forem concluídas.
...
Grupo planejado: `conhecimentos-especificos/legislacao-especial/`, título **Legislação Especial**, ordem **5**. O `grupo.json` ainda não existe e **não será criado vazio**; deve ser publicado junto com o primeiro pacote completo de U123. Consumidor comum: `pc-ma-2026-oficial-investigador` / `pcma-2026-invest`. Identidades preservadas `pc-u123`–`pc-u141`, ordens 123–141. Destinos: prefixo físico PC-MA + grupo + slug da tabela abaixo.
...
|---|---|---|---|---|---|---|---|
| 1 | U123 — Lei de Drogas — tráfico ilícito e uso indevido de substâncias entorpecentes — `lei-drogas-lei-11343` | Lei nº 11.343/2006 integral no estado aplicável ao corte; preservar Sistema Nacional de Políticas Públicas sobre Drogas, prevenção/tratamento, crimes, investigação e procedimento, sem reduzir o item apenas ao tráfico | nova/local; fontes primárias; sem doador integral | Lei nº 15.358/2026 alterou a Lei nº 11.343/2006 antes do corte; incorporar a redação aplicável mesmo que U140 seja produzida depois | pending | pending | pending |
